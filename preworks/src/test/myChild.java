...
public class myChild extends Child implements Cloneable {
	public myChild(int XJeNHAiL5U){super(XJeNHAiL5U);}

	private ArrayList compareFields = new ArrayList();

	public myChild clone() throws CloneNotSupportedException{
		myChild cloned = (myChild) super.clone();//浅克隆，克隆基本类型的字段
		...
		try {
    		for(Field field: fieldArr){//该类所有的public字段
				...
				//Log.v("clone myChild Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
...
;	}
	...
	@Override public boolean equals(Object other){
        ...
        myChild otherObj = (myChild) other;
        ...
        try{
            for(Field field:getClass().getFields()){
                ...
                //Log.v("compare myChild Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
                //Log.v("compare myChild Field",fieldThisValue+"---"+fieldOtherValue);
