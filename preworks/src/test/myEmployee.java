...
public class myEmployee extends Employee implements Cloneable {
	public myEmployee(java.lang.String U8tPM3dCdw, double CZrx2JuJbO, int Wgu8yQ50hO, int AEmkID3nZe, int G3fyjS1Qqz){super(U8tPM3dCdw, CZrx2JuJbO, Wgu8yQ50hO, AEmkID3nZe, G3fyjS1Qqz);}
	public myEmployee(java.lang.String Fm1TEf6Wzb, double UaeIgxwSoF, java.util.Date OgotGTlGcG){super(Fm1TEf6Wzb, UaeIgxwSoF, OgotGTlGcG);}

	private ArrayList compareFields = new ArrayList();

	public myEmployee clone() throws CloneNotSupportedException{
		myEmployee cloned = (myEmployee) super.clone();//浅克隆，克隆基本类型的字段
		...
		try {
    		for(Field field: fieldArr){//该类所有的public字段
				...
				//Log.v("clone myEmployee Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
