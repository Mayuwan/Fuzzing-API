...
public class myFather extends Father implements Cloneable {
	public myFather(){super();}

	private ArrayList compareFields = new ArrayList();

	public myFather clone() throws CloneNotSupportedException{
		myFather cloned = (myFather) super.clone();//浅克隆，克隆基本类型的字段
...
;	}
	...
	@Override public boolean equals(Object other){
        ...
        myFather otherObj = (myFather) other;
        ...
        try{
            for(Field field:getClass().getFields()){
                ...
                //Log.v("compare myFather Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
                //Log.v("compare myFather Field",fieldThisValue+"---"+fieldOtherValue);
