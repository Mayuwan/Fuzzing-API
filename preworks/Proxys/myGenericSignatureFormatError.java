...
public class myGenericSignatureFormatError extends GenericSignatureFormatError implements Cloneable {
	public myGenericSignatureFormatError(){super();}
	public myGenericSignatureFormatError(java.lang.String ZNMYCfY6GY){super(ZNMYCfY6GY);}

	private ArrayList compareFields = new ArrayList();

	public myGenericSignatureFormatError clone() throws CloneNotSupportedException{
		myGenericSignatureFormatError cloned = (myGenericSignatureFormatError) super.clone();//浅克隆，克隆基本类型的字段
		...
		try {
    		for(Field field: fieldArr){//该类所有的public字段
				...
				Log.v("clone myGenericSignatureFormatError Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
	...
	@Override public boolean equals(Object other){
        ...
        myGenericSignatureFormatError otherObj = (myGenericSignatureFormatError) other;
        ...
        try{
            for(Field field:getClass().getFields()){
                ...
                Log.v("compare myGenericSignatureFormatError Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
                Log.v("compare myGenericSignatureFormatError Field",fieldThisValue+"---"+fieldOtherValue);
