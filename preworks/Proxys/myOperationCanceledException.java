...
public class myOperationCanceledException extends OperationCanceledException implements Cloneable {
	public myOperationCanceledException(){super();}
	public myOperationCanceledException(java.lang.String I1OUEazOyH){super(I1OUEazOyH);}

	private ArrayList compareFields = new ArrayList();

	public myOperationCanceledException clone() throws CloneNotSupportedException{
		myOperationCanceledException cloned = (myOperationCanceledException) super.clone();//浅克隆，克隆基本类型的字段
		...
		try {
    		for(Field field: fieldArr){//该类所有的public字段
				...
				Log.v("clone myOperationCanceledException Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
	...
	@Override public boolean equals(Object other){
        ...
        myOperationCanceledException otherObj = (myOperationCanceledException) other;
        ...
        try{
            for(Field field:getClass().getFields()){
                ...
                Log.v("compare myOperationCanceledException Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
                Log.v("compare myOperationCanceledException Field",fieldThisValue+"---"+fieldOtherValue);
