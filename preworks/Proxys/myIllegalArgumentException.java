...
public class myIllegalArgumentException extends IllegalArgumentException implements Cloneable {
	public myIllegalArgumentException(){super();}
	public myIllegalArgumentException(java.lang.String EcO1wqb5zf){super(EcO1wqb5zf);}
	public myIllegalArgumentException(java.lang.String MNnCRq5uvA, java.lang.Throwable Zedry7S4P5){super(MNnCRq5uvA, Zedry7S4P5);}
	public myIllegalArgumentException(java.lang.Throwable XST4LwfSNc){super(XST4LwfSNc);}

	private ArrayList compareFields = new ArrayList();

	public myIllegalArgumentException clone() throws CloneNotSupportedException{
		myIllegalArgumentException cloned = (myIllegalArgumentException) super.clone();//浅克隆，克隆基本类型的字段
		...
		try {
    		for(Field field: fieldArr){//该类所有的public字段
				...
				Log.v("clone myIllegalArgumentException Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
	...
	@Override public boolean equals(Object other){
        ...
        myIllegalArgumentException otherObj = (myIllegalArgumentException) other;
        ...
        try{
            for(Field field:getClass().getFields()){
                ...
                Log.v("compare myIllegalArgumentException Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
                Log.v("compare myIllegalArgumentException Field",fieldThisValue+"---"+fieldOtherValue);
