...
public class myClassCircularityError extends ClassCircularityError implements Cloneable {
	public myClassCircularityError(){super();}
	public myClassCircularityError(java.lang.String PEQ6jGlZQB){super(PEQ6jGlZQB);}

	private ArrayList compareFields = new ArrayList();

	public myClassCircularityError clone() throws CloneNotSupportedException{
		myClassCircularityError cloned = (myClassCircularityError) super.clone();//浅克隆，克隆基本类型的字段
		...
		try {
    		for(Field field: fieldArr){//该类所有的public字段
				...
				Log.v("clone myClassCircularityError Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
	...
	@Override public boolean equals(Object other){
        ...
        myClassCircularityError otherObj = (myClassCircularityError) other;
        ...
        try{
            for(Field field:getClass().getFields()){
                ...
                Log.v("compare myClassCircularityError Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
                Log.v("compare myClassCircularityError Field",fieldThisValue+"---"+fieldOtherValue);
