...
public class myNoSuchMethodError extends NoSuchMethodError implements Cloneable {
	public myNoSuchMethodError(){super();}
	public myNoSuchMethodError(java.lang.String KYLu37pOFt){super(KYLu37pOFt);}

	private ArrayList compareFields = new ArrayList();

	public myNoSuchMethodError clone() throws CloneNotSupportedException{
		myNoSuchMethodError cloned = (myNoSuchMethodError) super.clone();//浅克隆，克隆基本类型的字段
		...
		try {
    		for(Field field: fieldArr){//该类所有的public字段
				...
				Log.v("clone myNoSuchMethodError Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
	...
	@Override public boolean equals(Object other){
        ...
        myNoSuchMethodError otherObj = (myNoSuchMethodError) other;
        ...
        try{
            for(Field field:getClass().getFields()){
                ...
                Log.v("compare myNoSuchMethodError Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
                Log.v("compare myNoSuchMethodError Field",fieldThisValue+"---"+fieldOtherValue);
