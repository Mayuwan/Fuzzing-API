...
public class myNumberFormatException extends NumberFormatException implements Cloneable {
	public myNumberFormatException(){super();}
	public myNumberFormatException(java.lang.String I91FhtxYxw){super(I91FhtxYxw);}

	private ArrayList compareFields = new ArrayList();

	public myNumberFormatException clone() throws CloneNotSupportedException{
		myNumberFormatException cloned = (myNumberFormatException) super.clone();//浅克隆，克隆基本类型的字段
		...
		try {
    		for(Field field: fieldArr){//该类所有的public字段
				...
				Log.v("clone myNumberFormatException Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
	...
	@Override public boolean equals(Object other){
        ...
        myNumberFormatException otherObj = (myNumberFormatException) other;
        ...
        try{
            for(Field field:getClass().getFields()){
                ...
                Log.v("compare myNumberFormatException Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
                Log.v("compare myNumberFormatException Field",fieldThisValue+"---"+fieldOtherValue);
