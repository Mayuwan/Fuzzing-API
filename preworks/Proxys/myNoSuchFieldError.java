...
public class myNoSuchFieldError extends NoSuchFieldError implements Cloneable {
	public myNoSuchFieldError(){super();}
	public myNoSuchFieldError(java.lang.String KftzhqYQv1){super(KftzhqYQv1);}

	private ArrayList compareFields = new ArrayList();

	public myNoSuchFieldError clone() throws CloneNotSupportedException{
		myNoSuchFieldError cloned = (myNoSuchFieldError) super.clone();//浅克隆，克隆基本类型的字段
		...
		try {
    		for(Field field: fieldArr){//该类所有的public字段
				...
				Log.v("clone myNoSuchFieldError Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
	...
	@Override public boolean equals(Object other){
        ...
        myNoSuchFieldError otherObj = (myNoSuchFieldError) other;
        ...
        try{
            for(Field field:getClass().getFields()){
                ...
                Log.v("compare myNoSuchFieldError Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
                Log.v("compare myNoSuchFieldError Field",fieldThisValue+"---"+fieldOtherValue);
