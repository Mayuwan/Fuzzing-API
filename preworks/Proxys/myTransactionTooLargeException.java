...
public class myTransactionTooLargeException extends TransactionTooLargeException implements Cloneable {
	public myTransactionTooLargeException(){super();}
	public myTransactionTooLargeException(java.lang.String Bufo3YY66T){super(Bufo3YY66T);}

	private ArrayList compareFields = new ArrayList();

	public myTransactionTooLargeException clone() throws CloneNotSupportedException{
		myTransactionTooLargeException cloned = (myTransactionTooLargeException) super.clone();//浅克隆，克隆基本类型的字段
		...
		try {
    		for(Field field: fieldArr){//该类所有的public字段
				...
				Log.v("clone myTransactionTooLargeException Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
	...
	@Override public boolean equals(Object other){
        ...
        myTransactionTooLargeException otherObj = (myTransactionTooLargeException) other;
        ...
        try{
            for(Field field:getClass().getFields()){
                ...
                Log.v("compare myTransactionTooLargeException Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
                Log.v("compare myTransactionTooLargeException Field",fieldThisValue+"---"+fieldOtherValue);
