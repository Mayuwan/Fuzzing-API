...
public class mySecurityManager extends SecurityManager implements Cloneable {
	public mySecurityManager(){super();}

	private ArrayList compareFields = new ArrayList();

	public mySecurityManager clone() throws CloneNotSupportedException{
		mySecurityManager cloned = (mySecurityManager) super.clone();//浅克隆，克隆基本类型的字段
		...
		try {
    		for(Field field: fieldArr){//该类所有的public字段
				...
				Log.v("clone mySecurityManager Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
	...
	@Override public boolean equals(Object other){
        ...
        mySecurityManager otherObj = (mySecurityManager) other;
        ...
        try{
            for(Field field:getClass().getFields()){
                ...
                Log.v("compare mySecurityManager Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
                Log.v("compare mySecurityManager Field",fieldThisValue+"---"+fieldOtherValue);
