...
public class myIntentFilter extends IntentFilter implements Cloneable {
	public myIntentFilter(){super();}
	public myIntentFilter(java.lang.String SdrvcPejrO){super(SdrvcPejrO);}
	public myIntentFilter(java.lang.String DPjqvez4Ly, java.lang.String N6gsv318tI){super(DPjqvez4Ly, N6gsv318tI);}
	public myIntentFilter(android.content.IntentFilter RVmoF7MiuQ){super(RVmoF7MiuQ);}

	private ArrayList compareFields = new ArrayList();

	public myIntentFilter clone() throws CloneNotSupportedException{
		myIntentFilter cloned = (myIntentFilter) super.clone();//浅克隆，克隆基本类型的字段
		...
		try {
    		for(Field field: fieldArr){//该类所有的public字段
				...
				Log.v("clone myIntentFilter Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
	...
	@Override public boolean equals(Object other){
        ...
        myIntentFilter otherObj = (myIntentFilter) other;
        ...
        try{
            for(Field field:getClass().getFields()){
                ...
                Log.v("compare myIntentFilter Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
                Log.v("compare myIntentFilter Field",fieldThisValue+"---"+fieldOtherValue);
