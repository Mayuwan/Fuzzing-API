...
public class myPermissionInfo extends PermissionInfo implements Cloneable {
	public myPermissionInfo(){super();}
	public myPermissionInfo(android.content.pm.PermissionInfo G725DCwm3H){super(G725DCwm3H);}

	private ArrayList compareFields = new ArrayList();

	public myPermissionInfo clone() throws CloneNotSupportedException{
		myPermissionInfo cloned = (myPermissionInfo) super.clone();//浅克隆，克隆基本类型的字段
		...
		try {
    		for(Field field: fieldArr){//该类所有的public字段
				...
				Log.v("clone myPermissionInfo Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
	...
	@Override public boolean equals(Object other){
        ...
        myPermissionInfo otherObj = (myPermissionInfo) other;
        ...
        try{
            for(Field field:getClass().getFields()){
                ...
                Log.v("compare myPermissionInfo Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
                Log.v("compare myPermissionInfo Field",fieldThisValue+"---"+fieldOtherValue);
