...
public class myReflectiveOperationException extends ReflectiveOperationException implements Cloneable {
	public myReflectiveOperationException(){super();}
	public myReflectiveOperationException(java.lang.String ND2S0eJp3K){super(ND2S0eJp3K);}
	public myReflectiveOperationException(java.lang.String VhMLk5mCiX, java.lang.Throwable H3yZXMRvRr){super(VhMLk5mCiX, H3yZXMRvRr);}
	public myReflectiveOperationException(java.lang.Throwable Tsm8L6QPJ3){super(Tsm8L6QPJ3);}

	private ArrayList compareFields = new ArrayList();

	public myReflectiveOperationException clone() throws CloneNotSupportedException{
		myReflectiveOperationException cloned = (myReflectiveOperationException) super.clone();//浅克隆，克隆基本类型的字段
		...
		try {
    		for(Field field: fieldArr){//该类所有的public字段
				...
				Log.v("clone myReflectiveOperationException Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
	...
	@Override public boolean equals(Object other){
        ...
        myReflectiveOperationException otherObj = (myReflectiveOperationException) other;
        ...
        try{
            for(Field field:getClass().getFields()){
                ...
                Log.v("compare myReflectiveOperationException Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
                Log.v("compare myReflectiveOperationException Field",fieldThisValue+"---"+fieldOtherValue);
