...
public class myHandler extends Handler implements Cloneable {
	public myHandler(){super();}
	public myHandler(android.os.Handler$Callback LDXFEvIFWl){super(LDXFEvIFWl);}
	public myHandler(android.os.Looper PJpAeZcnmk){super(PJpAeZcnmk);}
	public myHandler(android.os.Looper GvfuMn3pf7, android.os.Handler$Callback Da2VpB1F4v){super(GvfuMn3pf7, Da2VpB1F4v);}

	private ArrayList compareFields = new ArrayList();

	public myHandler clone() throws CloneNotSupportedException{
		myHandler cloned = (myHandler) super.clone();//浅克隆，克隆基本类型的字段
		...
		try {
    		for(Field field: fieldArr){//该类所有的public字段
				...
				Log.v("clone myHandler Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
	...
	@Override public boolean equals(Object other){
        ...
        myHandler otherObj = (myHandler) other;
        ...
        try{
            for(Field field:getClass().getFields()){
                ...
                Log.v("compare myHandler Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
                Log.v("compare myHandler Field",fieldThisValue+"---"+fieldOtherValue);
