...
public class myContentProviderResult extends ContentProviderResult implements Cloneable {
	public myContentProviderResult(android.net.Uri Wxz3durxTS){super(Wxz3durxTS);}
	public myContentProviderResult(int HgrfIKfYui){super(HgrfIKfYui);}
	public myContentProviderResult(android.os.Parcel TxjTWH2XFH){super(TxjTWH2XFH);}

	private ArrayList compareFields = new ArrayList();

	public myContentProviderResult clone() throws CloneNotSupportedException{
		myContentProviderResult cloned = (myContentProviderResult) super.clone();//浅克隆，克隆基本类型的字段
		...
		try {
    		for(Field field: fieldArr){//该类所有的public字段
				...
				Log.v("clone myContentProviderResult Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
	...
	@Override public boolean equals(Object other){
        ...
        myContentProviderResult otherObj = (myContentProviderResult) other;
        ...
        try{
            for(Field field:getClass().getFields()){
                ...
                Log.v("compare myContentProviderResult Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
                Log.v("compare myContentProviderResult Field",fieldThisValue+"---"+fieldOtherValue);
