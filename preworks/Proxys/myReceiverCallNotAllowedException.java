...
public class myReceiverCallNotAllowedException extends ReceiverCallNotAllowedException implements Cloneable {
	public myReceiverCallNotAllowedException(java.lang.String DRs7BmCQrJ){super(DRs7BmCQrJ);}

	private ArrayList compareFields = new ArrayList();

	public myReceiverCallNotAllowedException clone() throws CloneNotSupportedException{
		myReceiverCallNotAllowedException cloned = (myReceiverCallNotAllowedException) super.clone();//浅克隆，克隆基本类型的字段
		...
		try {
    		for(Field field: fieldArr){//该类所有的public字段
				...
				Log.v("clone myReceiverCallNotAllowedException Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
	...
	@Override public boolean equals(Object other){
        ...
        myReceiverCallNotAllowedException otherObj = (myReceiverCallNotAllowedException) other;
        ...
        try{
            for(Field field:getClass().getFields()){
                ...
                Log.v("compare myReceiverCallNotAllowedException Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
                Log.v("compare myReceiverCallNotAllowedException Field",fieldThisValue+"---"+fieldOtherValue);
