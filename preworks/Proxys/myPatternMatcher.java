...
public class myPatternMatcher extends PatternMatcher implements Cloneable {
	public myPatternMatcher(java.lang.String At0Z6TQjTi, int CXyQqHstrh){super(At0Z6TQjTi, CXyQqHstrh);}
	public myPatternMatcher(android.os.Parcel Yi6PbnUobm){super(Yi6PbnUobm);}

	private ArrayList compareFields = new ArrayList();

	public myPatternMatcher clone() throws CloneNotSupportedException{
		myPatternMatcher cloned = (myPatternMatcher) super.clone();//浅克隆，克隆基本类型的字段
		...
		try {
    		for(Field field: fieldArr){//该类所有的public字段
				...
				Log.v("clone myPatternMatcher Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
	...
	@Override public boolean equals(Object other){
        ...
        myPatternMatcher otherObj = (myPatternMatcher) other;
        ...
        try{
            for(Field field:getClass().getFields()){
                ...
                Log.v("compare myPatternMatcher Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
                Log.v("compare myPatternMatcher Field",fieldThisValue+"---"+fieldOtherValue);
