...
public class myContentQueryMap extends ContentQueryMap implements Cloneable {
	public myContentQueryMap(android.database.Cursor VSsmjZqWyH, java.lang.String NcxZ5o4B4W, boolean YuDGWZkOyq, android.os.Handler HnzLoDuFjk){super(VSsmjZqWyH, NcxZ5o4B4W, YuDGWZkOyq, HnzLoDuFjk);}

	private ArrayList compareFields = new ArrayList();

	public myContentQueryMap clone() throws CloneNotSupportedException{
		myContentQueryMap cloned = (myContentQueryMap) super.clone();//浅克隆，克隆基本类型的字段
		...
		try {
    		for(Field field: fieldArr){//该类所有的public字段
				...
				Log.v("clone myContentQueryMap Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
	...
	@Override public boolean equals(Object other){
        ...
        myContentQueryMap otherObj = (myContentQueryMap) other;
        ...
        try{
            for(Field field:getClass().getFields()){
                ...
                Log.v("compare myContentQueryMap Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
                Log.v("compare myContentQueryMap Field",fieldThisValue+"---"+fieldOtherValue);
