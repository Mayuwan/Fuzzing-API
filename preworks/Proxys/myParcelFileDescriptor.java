...
public class myParcelFileDescriptor extends ParcelFileDescriptor implements Cloneable {
	public myParcelFileDescriptor(android.os.ParcelFileDescriptor PIMokxkMlM){super(PIMokxkMlM);}

	private ArrayList compareFields = new ArrayList();

	public myParcelFileDescriptor clone() throws CloneNotSupportedException{
		myParcelFileDescriptor cloned = (myParcelFileDescriptor) super.clone();//浅克隆，克隆基本类型的字段
		...
		try {
    		for(Field field: fieldArr){//该类所有的public字段
				...
				Log.v("clone myParcelFileDescriptor Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
	...
	@Override public boolean equals(Object other){
        ...
        myParcelFileDescriptor otherObj = (myParcelFileDescriptor) other;
        ...
        try{
            for(Field field:getClass().getFields()){
                ...
                Log.v("compare myParcelFileDescriptor Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
                Log.v("compare myParcelFileDescriptor Field",fieldThisValue+"---"+fieldOtherValue);
