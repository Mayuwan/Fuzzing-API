...
public class myPathPermission extends PathPermission implements Cloneable {
	public myPathPermission(java.lang.String XCNZD4Tv2J, int ULAdkl3cXs, java.lang.String ZV0DA4YSS4, java.lang.String N983uOnjj4){super(XCNZD4Tv2J, ULAdkl3cXs, ZV0DA4YSS4, N983uOnjj4);}
	public myPathPermission(android.os.Parcel BLI1KS2I0w){super(BLI1KS2I0w);}

	private ArrayList compareFields = new ArrayList();

	public myPathPermission clone() throws CloneNotSupportedException{
		myPathPermission cloned = (myPathPermission) super.clone();//浅克隆，克隆基本类型的字段
		...
		try {
    		for(Field field: fieldArr){//该类所有的public字段
				...
				Log.v("clone myPathPermission Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
	...
	@Override public boolean equals(Object other){
        ...
        myPathPermission otherObj = (myPathPermission) other;
        ...
        try{
            for(Field field:getClass().getFields()){
                ...
                Log.v("compare myPathPermission Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
                Log.v("compare myPathPermission Field",fieldThisValue+"---"+fieldOtherValue);
