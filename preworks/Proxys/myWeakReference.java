...
public class myWeakReference extends WeakReference implements Cloneable {
	public myWeakReference(java.lang.Object FiCfJwWizj){super(FiCfJwWizj);}
	public myWeakReference(java.lang.Object DtYAZFacDU, java.lang.ref.ReferenceQueue NNS5iNTGQM){super(DtYAZFacDU, NNS5iNTGQM);}

	private ArrayList compareFields = new ArrayList();

	public myWeakReference clone() throws CloneNotSupportedException{
		myWeakReference cloned = (myWeakReference) super.clone();//浅克隆，克隆基本类型的字段
		...
		try {
    		for(Field field: fieldArr){//该类所有的public字段
				...
				Log.v("clone myWeakReference Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
	...
	@Override public boolean equals(Object other){
        ...
        myWeakReference otherObj = (myWeakReference) other;
        ...
        try{
            for(Field field:getClass().getFields()){
                ...
                Log.v("compare myWeakReference Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
                Log.v("compare myWeakReference Field",fieldThisValue+"---"+fieldOtherValue);
