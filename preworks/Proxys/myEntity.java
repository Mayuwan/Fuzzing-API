...
public class myEntity extends Entity implements Cloneable {
	public myEntity(android.content.ContentValues KwJW6cIBbm){super(KwJW6cIBbm);}

	private ArrayList compareFields = new ArrayList();

	public myEntity clone() throws CloneNotSupportedException{
		myEntity cloned = (myEntity) super.clone();//浅克隆，克隆基本类型的字段
		...
		try {
    		for(Field field: fieldArr){//该类所有的public字段
				...
				Log.v("clone myEntity Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
	...
	@Override public boolean equals(Object other){
        ...
        myEntity otherObj = (myEntity) other;
        ...
        try{
            for(Field field:getClass().getFields()){
                ...
                Log.v("compare myEntity Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
                Log.v("compare myEntity Field",fieldThisValue+"---"+fieldOtherValue);
