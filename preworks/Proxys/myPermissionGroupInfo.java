...
public class myPermissionGroupInfo extends PermissionGroupInfo implements Cloneable {
	public myPermissionGroupInfo(){super();}
	public myPermissionGroupInfo(android.content.pm.PermissionGroupInfo UHcICLYEvh){super(UHcICLYEvh);}

	private ArrayList compareFields = new ArrayList();

	public myPermissionGroupInfo clone() throws CloneNotSupportedException{
		myPermissionGroupInfo cloned = (myPermissionGroupInfo) super.clone();//浅克隆，克隆基本类型的字段
		...
		try {
    		for(Field field: fieldArr){//该类所有的public字段
				...
				Log.v("clone myPermissionGroupInfo Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
	...
	@Override public boolean equals(Object other){
        ...
        myPermissionGroupInfo otherObj = (myPermissionGroupInfo) other;
        ...
        try{
            for(Field field:getClass().getFields()){
                ...
                Log.v("compare myPermissionGroupInfo Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
                Log.v("compare myPermissionGroupInfo Field",fieldThisValue+"---"+fieldOtherValue);
