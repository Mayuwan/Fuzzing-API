...
public class myAnimatorInflater extends AnimatorInflater implements Cloneable {
	public myAnimatorInflater(){super();}

	private ArrayList compareFields = new ArrayList();

	public myAnimatorInflater clone() throws CloneNotSupportedException{
		myAnimatorInflater cloned = (myAnimatorInflater) super.clone();//浅克隆，克隆基本类型的字段
		...
		try {
    		for(Field field: fieldArr){//该类所有的public字段
				...
				Log.v("clone myAnimatorInflater Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
	...
	@Override public boolean equals(Object other){
        ...
        myAnimatorInflater otherObj = (myAnimatorInflater) other;
        ...
        try{
            for(Field field:getClass().getFields()){
                ...
                Log.v("compare myAnimatorInflater Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
                Log.v("compare myAnimatorInflater Field",fieldThisValue+"---"+fieldOtherValue);
