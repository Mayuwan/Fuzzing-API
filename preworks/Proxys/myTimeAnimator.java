...
public class myTimeAnimator extends TimeAnimator implements Cloneable {
	public myTimeAnimator(){super();}

	private ArrayList compareFields = new ArrayList();

	public myTimeAnimator clone() throws CloneNotSupportedException{
		myTimeAnimator cloned = (myTimeAnimator) super.clone();//浅克隆，克隆基本类型的字段
		...
		try {
    		for(Field field: fieldArr){//该类所有的public字段
				...
				Log.v("clone myTimeAnimator Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
	...
	@Override public boolean equals(Object other){
        ...
        myTimeAnimator otherObj = (myTimeAnimator) other;
        ...
        try{
            for(Field field:getClass().getFields()){
                ...
                Log.v("compare myTimeAnimator Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
                Log.v("compare myTimeAnimator Field",fieldThisValue+"---"+fieldOtherValue);
