...
public class mySoftReference extends SoftReference implements Cloneable {
	public mySoftReference(java.lang.Object KlWuCcEiUH){super(KlWuCcEiUH);}
	public mySoftReference(java.lang.Object PQGQfj4QPg, java.lang.ref.ReferenceQueue Bb0bqI0xqW){super(PQGQfj4QPg, Bb0bqI0xqW);}

	private ArrayList compareFields = new ArrayList();

	public mySoftReference clone() throws CloneNotSupportedException{
		mySoftReference cloned = (mySoftReference) super.clone();//浅克隆，克隆基本类型的字段
		...
		try {
    		for(Field field: fieldArr){//该类所有的public字段
				...
				Log.v("clone mySoftReference Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
	...
	@Override public boolean equals(Object other){
        ...
        mySoftReference otherObj = (mySoftReference) other;
        ...
        try{
            for(Field field:getClass().getFields()){
                ...
                Log.v("compare mySoftReference Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
                Log.v("compare mySoftReference Field",fieldThisValue+"---"+fieldOtherValue);
