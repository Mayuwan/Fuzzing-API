...
public class myClipData extends ClipData implements Cloneable {
	public myClipData(java.lang.CharSequence YjZJSuWdY0, java.lang.String[] QD2ItOt831, android.content.ClipData$Item B8yLzRO0Nw){super(YjZJSuWdY0, QD2ItOt831, B8yLzRO0Nw);}
	public myClipData(android.content.ClipDescription ENI6ynPojv, android.content.ClipData$Item CWl2H1oWyS){super(ENI6ynPojv, CWl2H1oWyS);}
	public myClipData(android.content.ClipData DX9PPzZ0Hf){super(DX9PPzZ0Hf);}

	private ArrayList compareFields = new ArrayList();

	public myClipData clone() throws CloneNotSupportedException{
		myClipData cloned = (myClipData) super.clone();//浅克隆，克隆基本类型的字段
		...
		try {
    		for(Field field: fieldArr){//该类所有的public字段
				...
				Log.v("clone myClipData Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
	...
	@Override public boolean equals(Object other){
        ...
        myClipData otherObj = (myClipData) other;
        ...
        try{
            for(Field field:getClass().getFields()){
                ...
                Log.v("compare myClipData Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
                Log.v("compare myClipData Field",fieldThisValue+"---"+fieldOtherValue);
