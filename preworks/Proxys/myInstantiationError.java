...
public class myInstantiationError extends InstantiationError implements Cloneable {
	public myInstantiationError(){super();}
	public myInstantiationError(java.lang.String AKi8WDTxhM){super(AKi8WDTxhM);}

	private ArrayList compareFields = new ArrayList();

	public myInstantiationError clone() throws CloneNotSupportedException{
		myInstantiationError cloned = (myInstantiationError) super.clone();//浅克隆，克隆基本类型的字段
		...
		try {
    		for(Field field: fieldArr){//该类所有的public字段
				...
				Log.v("clone myInstantiationError Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
	...
	@Override public boolean equals(Object other){
        ...
        myInstantiationError otherObj = (myInstantiationError) other;
        ...
        try{
            for(Field field:getClass().getFields()){
                ...
                Log.v("compare myInstantiationError Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
                Log.v("compare myInstantiationError Field",fieldThisValue+"---"+fieldOtherValue);
