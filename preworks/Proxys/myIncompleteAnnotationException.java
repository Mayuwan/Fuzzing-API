...
public class myIncompleteAnnotationException extends IncompleteAnnotationException implements Cloneable {
	public myIncompleteAnnotationException(java.lang.Class Z5eqAOTi5d, java.lang.String EZ9kbFdjRb){super(Z5eqAOTi5d, EZ9kbFdjRb);}

	private ArrayList compareFields = new ArrayList();

	public myIncompleteAnnotationException clone() throws CloneNotSupportedException{
		myIncompleteAnnotationException cloned = (myIncompleteAnnotationException) super.clone();//浅克隆，克隆基本类型的字段
		...
		try {
    		for(Field field: fieldArr){//该类所有的public字段
				...
				Log.v("clone myIncompleteAnnotationException Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
	...
	@Override public boolean equals(Object other){
        ...
        myIncompleteAnnotationException otherObj = (myIncompleteAnnotationException) other;
        ...
        try{
            for(Field field:getClass().getFields()){
                ...
                Log.v("compare myIncompleteAnnotationException Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
                Log.v("compare myIncompleteAnnotationException Field",fieldThisValue+"---"+fieldOtherValue);
