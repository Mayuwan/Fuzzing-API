...
public class myDeadSystemException extends DeadSystemException implements Cloneable {
	public myDeadSystemException(){super();}

	private ArrayList compareFields = new ArrayList();

	public myDeadSystemException clone() throws CloneNotSupportedException{
		myDeadSystemException cloned = (myDeadSystemException) super.clone();//浅克隆，克隆基本类型的字段
		...
		try {
    		for(Field field: fieldArr){//该类所有的public字段
				...
				Log.v("clone myDeadSystemException Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
	...
	@Override public boolean equals(Object other){
        ...
        myDeadSystemException otherObj = (myDeadSystemException) other;
        ...
        try{
            for(Field field:getClass().getFields()){
                ...
                Log.v("compare myDeadSystemException Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
                Log.v("compare myDeadSystemException Field",fieldThisValue+"---"+fieldOtherValue);
