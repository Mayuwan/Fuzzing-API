...
public class myActivityNotFoundException extends ActivityNotFoundException implements Cloneable {
	public myActivityNotFoundException(){super();}
	public myActivityNotFoundException(java.lang.String CQ6Wvlv3LO){super(CQ6Wvlv3LO);}

	private ArrayList compareFields = new ArrayList();

	public myActivityNotFoundException clone() throws CloneNotSupportedException{
		myActivityNotFoundException cloned = (myActivityNotFoundException) super.clone();//浅克隆，克隆基本类型的字段
		...
		try {
    		for(Field field: fieldArr){//该类所有的public字段
				...
				Log.v("clone myActivityNotFoundException Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
	...
	@Override public boolean equals(Object other){
        ...
        myActivityNotFoundException otherObj = (myActivityNotFoundException) other;
        ...
        try{
            for(Field field:getClass().getFields()){
                ...
                Log.v("compare myActivityNotFoundException Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
                Log.v("compare myActivityNotFoundException Field",fieldThisValue+"---"+fieldOtherValue);
