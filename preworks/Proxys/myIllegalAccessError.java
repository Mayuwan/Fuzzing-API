...
public class myIllegalAccessError extends IllegalAccessError implements Cloneable {
	public myIllegalAccessError(){super();}
	public myIllegalAccessError(java.lang.String Q3NQPbjNDN){super(Q3NQPbjNDN);}

	private ArrayList compareFields = new ArrayList();

	public myIllegalAccessError clone() throws CloneNotSupportedException{
		myIllegalAccessError cloned = (myIllegalAccessError) super.clone();//浅克隆，克隆基本类型的字段
		...
		try {
    		for(Field field: fieldArr){//该类所有的public字段
				...
				Log.v("clone myIllegalAccessError Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
	...
	@Override public boolean equals(Object other){
        ...
        myIllegalAccessError otherObj = (myIllegalAccessError) other;
        ...
        try{
            for(Field field:getClass().getFields()){
                ...
                Log.v("compare myIllegalAccessError Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
                Log.v("compare myIllegalAccessError Field",fieldThisValue+"---"+fieldOtherValue);
