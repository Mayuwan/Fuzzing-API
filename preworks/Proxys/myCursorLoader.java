...
public class myCursorLoader extends CursorLoader implements Cloneable {
	public myCursorLoader(android.content.Context NGUuhhgYoT){super(NGUuhhgYoT);}
	public myCursorLoader(android.content.Context S8ChZVB9Eq, android.net.Uri HB8JnQNzB0, java.lang.String[] ZiuSnQDiz5, java.lang.String NE2X7r4ziU, java.lang.String[] QPGyJhdlFs, java.lang.String AtHpNL6ncr){super(S8ChZVB9Eq, HB8JnQNzB0, ZiuSnQDiz5, NE2X7r4ziU, QPGyJhdlFs, AtHpNL6ncr);}

	private ArrayList compareFields = new ArrayList();

	public myCursorLoader clone() throws CloneNotSupportedException{
		myCursorLoader cloned = (myCursorLoader) super.clone();//浅克隆，克隆基本类型的字段
		...
		try {
    		for(Field field: fieldArr){//该类所有的public字段
				...
				Log.v("clone myCursorLoader Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
	...
	@Override public boolean equals(Object other){
        ...
        myCursorLoader otherObj = (myCursorLoader) other;
        ...
        try{
            for(Field field:getClass().getFields()){
                ...
                Log.v("compare myCursorLoader Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
                Log.v("compare myCursorLoader Field",fieldThisValue+"---"+fieldOtherValue);
