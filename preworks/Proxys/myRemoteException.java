...
public class myRemoteException extends RemoteException implements Cloneable {
	public myRemoteException(){super();}
	public myRemoteException(java.lang.String SkjkUSeijx){super(SkjkUSeijx);}

	private ArrayList compareFields = new ArrayList();

	public myRemoteException clone() throws CloneNotSupportedException{
		myRemoteException cloned = (myRemoteException) super.clone();//浅克隆，克隆基本类型的字段
		...
		try {
    		for(Field field: fieldArr){//该类所有的public字段
				...
				Log.v("clone myRemoteException Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
	...
	@Override public boolean equals(Object other){
        ...
        myRemoteException otherObj = (myRemoteException) other;
        ...
        try{
            for(Field field:getClass().getFields()){
                ...
                Log.v("compare myRemoteException Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
                Log.v("compare myRemoteException Field",fieldThisValue+"---"+fieldOtherValue);
