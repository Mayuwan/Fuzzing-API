...
public class myException extends Exception implements Cloneable {
	public myException(){super();}
	public myException(java.lang.String FciDJCK8cs){super(FciDJCK8cs);}
	public myException(java.lang.String Ad0lczvIwF, java.lang.Throwable JkECG0gghs){super(Ad0lczvIwF, JkECG0gghs);}
	public myException(java.lang.Throwable C94i1VOTm1){super(C94i1VOTm1);}
	protected myException(java.lang.String V71HQHc7j0, java.lang.Throwable SVPZmau40I, boolean KiDRFrZOsB, boolean UBbfXUL7mM){super(V71HQHc7j0, SVPZmau40I, KiDRFrZOsB, UBbfXUL7mM);}

	private ArrayList compareFields = new ArrayList();

	public myException clone() throws CloneNotSupportedException{
		myException cloned = (myException) super.clone();//浅克隆，克隆基本类型的字段
		...
		try {
    		for(Field field: fieldArr){//该类所有的public字段
				...
				Log.v("clone myException Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
	...
	@Override public boolean equals(Object other){
        ...
        myException otherObj = (myException) other;
        ...
        try{
            for(Field field:getClass().getFields()){
                ...
                Log.v("compare myException Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
                Log.v("compare myException Field",fieldThisValue+"---"+fieldOtherValue);
