...
public class myStringIndexOutOfBoundsException extends StringIndexOutOfBoundsException implements Cloneable {
	public myStringIndexOutOfBoundsException(){super();}
	public myStringIndexOutOfBoundsException(java.lang.String ECq7tnZpKC){super(ECq7tnZpKC);}
	public myStringIndexOutOfBoundsException(int S4kcnQKfb4){super(S4kcnQKfb4);}

	private ArrayList compareFields = new ArrayList();

	public myStringIndexOutOfBoundsException clone() throws CloneNotSupportedException{
		myStringIndexOutOfBoundsException cloned = (myStringIndexOutOfBoundsException) super.clone();//浅克隆，克隆基本类型的字段
		...
		try {
    		for(Field field: fieldArr){//该类所有的public字段
				...
				Log.v("clone myStringIndexOutOfBoundsException Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
	...
	@Override public boolean equals(Object other){
        ...
        myStringIndexOutOfBoundsException otherObj = (myStringIndexOutOfBoundsException) other;
        ...
        try{
            for(Field field:getClass().getFields()){
                ...
                Log.v("compare myStringIndexOutOfBoundsException Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
                Log.v("compare myStringIndexOutOfBoundsException Field",fieldThisValue+"---"+fieldOtherValue);
