...
public class myAnnotationTypeMismatchException extends AnnotationTypeMismatchException implements Cloneable {
	public myAnnotationTypeMismatchException(java.lang.reflect.Method L4UN6UvkZX, java.lang.String K6go0jb73D){super(L4UN6UvkZX, K6go0jb73D);}

	private ArrayList compareFields = new ArrayList();

	public myAnnotationTypeMismatchException clone() throws CloneNotSupportedException{
		myAnnotationTypeMismatchException cloned = (myAnnotationTypeMismatchException) super.clone();//浅克隆，克隆基本类型的字段
		...
		try {
    		for(Field field: fieldArr){//该类所有的public字段
				...
				Log.v("clone myAnnotationTypeMismatchException Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
	...
	@Override public boolean equals(Object other){
        ...
        myAnnotationTypeMismatchException otherObj = (myAnnotationTypeMismatchException) other;
        ...
        try{
            for(Field field:getClass().getFields()){
                ...
                Log.v("compare myAnnotationTypeMismatchException Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
                Log.v("compare myAnnotationTypeMismatchException Field",fieldThisValue+"---"+fieldOtherValue);
