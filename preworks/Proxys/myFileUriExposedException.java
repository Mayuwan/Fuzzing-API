...
public class myFileUriExposedException extends FileUriExposedException implements Cloneable {
	public myFileUriExposedException(java.lang.String Jvkzgv6NGh){super(Jvkzgv6NGh);}

	private ArrayList compareFields = new ArrayList();

	public myFileUriExposedException clone() throws CloneNotSupportedException{
		myFileUriExposedException cloned = (myFileUriExposedException) super.clone();//浅克隆，克隆基本类型的字段
		...
		try {
    		for(Field field: fieldArr){//该类所有的public字段
				...
				Log.v("clone myFileUriExposedException Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
	...
	@Override public boolean equals(Object other){
        ...
        myFileUriExposedException otherObj = (myFileUriExposedException) other;
        ...
        try{
            for(Field field:getClass().getFields()){
                ...
                Log.v("compare myFileUriExposedException Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
                Log.v("compare myFileUriExposedException Field",fieldThisValue+"---"+fieldOtherValue);
