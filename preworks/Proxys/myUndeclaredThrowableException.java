...
public class myUndeclaredThrowableException extends UndeclaredThrowableException implements Cloneable {
	public myUndeclaredThrowableException(java.lang.Throwable EzMybxn0jn){super(EzMybxn0jn);}
	public myUndeclaredThrowableException(java.lang.Throwable NhftFJjtgs, java.lang.String J4QogoR4Vr){super(NhftFJjtgs, J4QogoR4Vr);}

	private ArrayList compareFields = new ArrayList();

	public myUndeclaredThrowableException clone() throws CloneNotSupportedException{
		myUndeclaredThrowableException cloned = (myUndeclaredThrowableException) super.clone();//浅克隆，克隆基本类型的字段
		...
		try {
    		for(Field field: fieldArr){//该类所有的public字段
				...
				Log.v("clone myUndeclaredThrowableException Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
	...
	@Override public boolean equals(Object other){
        ...
        myUndeclaredThrowableException otherObj = (myUndeclaredThrowableException) other;
        ...
        try{
            for(Field field:getClass().getFields()){
                ...
                Log.v("compare myUndeclaredThrowableException Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
                Log.v("compare myUndeclaredThrowableException Field",fieldThisValue+"---"+fieldOtherValue);
