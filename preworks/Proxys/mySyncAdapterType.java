...
public class mySyncAdapterType extends SyncAdapterType implements Cloneable {
	public mySyncAdapterType(java.lang.String XFr4KRJTvY, java.lang.String VgZyq9WRt1, boolean ZywwfIj5Ct, boolean ITNfTpeMEl){super(XFr4KRJTvY, VgZyq9WRt1, ZywwfIj5Ct, ITNfTpeMEl);}
	public mySyncAdapterType(android.os.Parcel O6qCkUFyQr){super(O6qCkUFyQr);}

	private ArrayList compareFields = new ArrayList();

	public mySyncAdapterType clone() throws CloneNotSupportedException{
		mySyncAdapterType cloned = (mySyncAdapterType) super.clone();//浅克隆，克隆基本类型的字段
		...
		try {
    		for(Field field: fieldArr){//该类所有的public字段
				...
				Log.v("clone mySyncAdapterType Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
