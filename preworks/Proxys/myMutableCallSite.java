...
public class myMutableCallSite extends MutableCallSite implements Cloneable {
	public myMutableCallSite(java.lang.invoke.MethodType ZsB40PzW4e){super(ZsB40PzW4e);}
	public myMutableCallSite(java.lang.invoke.MethodHandle Xv4yS5Utez){super(Xv4yS5Utez);}

	private ArrayList compareFields = new ArrayList();

	public myMutableCallSite clone() throws CloneNotSupportedException{
		myMutableCallSite cloned = (myMutableCallSite) super.clone();//浅克隆，克隆基本类型的字段
		...
		try {
    		for(Field field: fieldArr){//该类所有的public字段
				...
				Log.v("clone myMutableCallSite Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
	...
	@Override public boolean equals(Object other){
        ...
        myMutableCallSite otherObj = (myMutableCallSite) other;
        ...
        try{
            for(Field field:getClass().getFields()){
                ...
                Log.v("compare myMutableCallSite Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
                Log.v("compare myMutableCallSite Field",fieldThisValue+"---"+fieldOtherValue);
