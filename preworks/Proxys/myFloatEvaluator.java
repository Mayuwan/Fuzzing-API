...
public class myFloatEvaluator extends FloatEvaluator implements Cloneable {
	public myFloatEvaluator(){super();}

	private ArrayList compareFields = new ArrayList();

	public myFloatEvaluator clone() throws CloneNotSupportedException{
		myFloatEvaluator cloned = (myFloatEvaluator) super.clone();//浅克隆，克隆基本类型的字段
		...
		try {
    		for(Field field: fieldArr){//该类所有的public字段
				...
				Log.v("clone myFloatEvaluator Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
	...
	@Override public boolean equals(Object other){
        ...
        myFloatEvaluator otherObj = (myFloatEvaluator) other;
        ...
        try{
            for(Field field:getClass().getFields()){
                ...
                Log.v("compare myFloatEvaluator Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
                Log.v("compare myFloatEvaluator Field",fieldThisValue+"---"+fieldOtherValue);
