...
public class myThrowable extends Throwable implements Cloneable {
	public myThrowable(){super();}
	public myThrowable(java.lang.String Juu7BLEmeJ){super(Juu7BLEmeJ);}
	public myThrowable(java.lang.String YTqSIYKffS, java.lang.Throwable IRg4DCgEDk){super(YTqSIYKffS, IRg4DCgEDk);}
	public myThrowable(java.lang.Throwable GvFVcB6qJd){super(GvFVcB6qJd);}
	protected myThrowable(java.lang.String WStUvL2Kpj, java.lang.Throwable Jz0XRDFOgU, boolean AxU22qwoxn, boolean Z4ItDJGVft){super(WStUvL2Kpj, Jz0XRDFOgU, AxU22qwoxn, Z4ItDJGVft);}

	private ArrayList compareFields = new ArrayList();

	public myThrowable clone() throws CloneNotSupportedException{
		myThrowable cloned = (myThrowable) super.clone();//浅克隆，克隆基本类型的字段
		...
		try {
    		for(Field field: fieldArr){//该类所有的public字段
				...
				Log.v("clone myThrowable Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
	...
	@Override public boolean equals(Object other){
        ...
        myThrowable otherObj = (myThrowable) other;
        ...
        try{
            for(Field field:getClass().getFields()){
                ...
                Log.v("compare myThrowable Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
                Log.v("compare myThrowable Field",fieldThisValue+"---"+fieldOtherValue);
