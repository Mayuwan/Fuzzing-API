...
public class myNoSuchMethodException extends NoSuchMethodException implements Cloneable {
	public myNoSuchMethodException(){super();}
	public myNoSuchMethodException(java.lang.String Lcz1dg1qXY){super(Lcz1dg1qXY);}

	private ArrayList compareFields = new ArrayList();

	public myNoSuchMethodException clone() throws CloneNotSupportedException{
		myNoSuchMethodException cloned = (myNoSuchMethodException) super.clone();//浅克隆，克隆基本类型的字段
		...
		try {
    		for(Field field: fieldArr){//该类所有的public字段
				...
				Log.v("clone myNoSuchMethodException Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
	...
	@Override public boolean equals(Object other){
        ...
        myNoSuchMethodException otherObj = (myNoSuchMethodException) other;
        ...
        try{
            for(Field field:getClass().getFields()){
                ...
                Log.v("compare myNoSuchMethodException Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
                Log.v("compare myNoSuchMethodException Field",fieldThisValue+"---"+fieldOtherValue);
