...
public class myFeatureInfo extends FeatureInfo implements Cloneable {
	public myFeatureInfo(){super();}
	public myFeatureInfo(android.content.pm.FeatureInfo MK2ptWi5XY){super(MK2ptWi5XY);}

	private ArrayList compareFields = new ArrayList();

	public myFeatureInfo clone() throws CloneNotSupportedException{
		myFeatureInfo cloned = (myFeatureInfo) super.clone();//浅克隆，克隆基本类型的字段
		...
		try {
    		for(Field field: fieldArr){//该类所有的public字段
				...
				Log.v("clone myFeatureInfo Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
	...
	@Override public boolean equals(Object other){
        ...
        myFeatureInfo otherObj = (myFeatureInfo) other;
        ...
        try{
            for(Field field:getClass().getFields()){
                ...
                Log.v("compare myFeatureInfo Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
                Log.v("compare myFeatureInfo Field",fieldThisValue+"---"+fieldOtherValue);
