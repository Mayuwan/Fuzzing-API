...
public class myNegativeArraySizeException extends NegativeArraySizeException implements Cloneable {
	public myNegativeArraySizeException(){super();}
	public myNegativeArraySizeException(java.lang.String Z7ZpwNQDoW){super(Z7ZpwNQDoW);}

	private ArrayList compareFields = new ArrayList();

	public myNegativeArraySizeException clone() throws CloneNotSupportedException{
		myNegativeArraySizeException cloned = (myNegativeArraySizeException) super.clone();//浅克隆，克隆基本类型的字段
		...
		try {
    		for(Field field: fieldArr){//该类所有的public字段
				...
				Log.v("clone myNegativeArraySizeException Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
	...
	@Override public boolean equals(Object other){
        ...
        myNegativeArraySizeException otherObj = (myNegativeArraySizeException) other;
        ...
        try{
            for(Field field:getClass().getFields()){
                ...
                Log.v("compare myNegativeArraySizeException Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
                Log.v("compare myNegativeArraySizeException Field",fieldThisValue+"---"+fieldOtherValue);
