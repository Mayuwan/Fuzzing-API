...
public class myIllegalThreadStateException extends IllegalThreadStateException implements Cloneable {
	public myIllegalThreadStateException(){super();}
	public myIllegalThreadStateException(java.lang.String Gn3iYsPzxY){super(Gn3iYsPzxY);}

	private ArrayList compareFields = new ArrayList();

	public myIllegalThreadStateException clone() throws CloneNotSupportedException{
		myIllegalThreadStateException cloned = (myIllegalThreadStateException) super.clone();//浅克隆，克隆基本类型的字段
		...
		try {
    		for(Field field: fieldArr){//该类所有的public字段
				...
				Log.v("clone myIllegalThreadStateException Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
	...
	@Override public boolean equals(Object other){
        ...
        myIllegalThreadStateException otherObj = (myIllegalThreadStateException) other;
        ...
        try{
            for(Field field:getClass().getFields()){
                ...
                Log.v("compare myIllegalThreadStateException Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
                Log.v("compare myIllegalThreadStateException Field",fieldThisValue+"---"+fieldOtherValue);
