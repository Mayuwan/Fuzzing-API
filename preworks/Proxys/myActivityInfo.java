...
public class myActivityInfo extends ActivityInfo implements Cloneable {
	public myActivityInfo(){super();}
	public myActivityInfo(android.content.pm.ActivityInfo AFFC31JArL){super(AFFC31JArL);}

	private ArrayList compareFields = new ArrayList();

	public myActivityInfo clone() throws CloneNotSupportedException{
		myActivityInfo cloned = (myActivityInfo) super.clone();//浅克隆，克隆基本类型的字段
		...
		try {
    		for(Field field: fieldArr){//该类所有的public字段
				...
				Log.v("clone myActivityInfo Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
	...
	@Override public boolean equals(Object other){
        ...
        myActivityInfo otherObj = (myActivityInfo) other;
        ...
        try{
            for(Field field:getClass().getFields()){
                ...
                Log.v("compare myActivityInfo Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
                Log.v("compare myActivityInfo Field",fieldThisValue+"---"+fieldOtherValue);
