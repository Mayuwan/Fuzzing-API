...
public class myBadParcelableException extends BadParcelableException implements Cloneable {
	public myBadParcelableException(java.lang.String KTx3cOiS3o){super(KTx3cOiS3o);}
	public myBadParcelableException(java.lang.Exception NNj7V9Falu){super(NNj7V9Falu);}

	private ArrayList compareFields = new ArrayList();

	public myBadParcelableException clone() throws CloneNotSupportedException{
		myBadParcelableException cloned = (myBadParcelableException) super.clone();//浅克隆，克隆基本类型的字段
		...
		try {
    		for(Field field: fieldArr){//该类所有的public字段
				...
				Log.v("clone myBadParcelableException Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
	...
	@Override public boolean equals(Object other){
        ...
        myBadParcelableException otherObj = (myBadParcelableException) other;
        ...
        try{
            for(Field field:getClass().getFields()){
                ...
                Log.v("compare myBadParcelableException Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
                Log.v("compare myBadParcelableException Field",fieldThisValue+"---"+fieldOtherValue);
