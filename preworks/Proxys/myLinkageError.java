...
public class myLinkageError extends LinkageError implements Cloneable {
	public myLinkageError(){super();}
	public myLinkageError(java.lang.String MOGHUYcfU1){super(MOGHUYcfU1);}
	public myLinkageError(java.lang.String K86ZAKo5Xx, java.lang.Throwable IOf3E0H5cA){super(K86ZAKo5Xx, IOf3E0H5cA);}

	private ArrayList compareFields = new ArrayList();

	public myLinkageError clone() throws CloneNotSupportedException{
		myLinkageError cloned = (myLinkageError) super.clone();//浅克隆，克隆基本类型的字段
		...
		try {
    		for(Field field: fieldArr){//该类所有的public字段
				...
				Log.v("clone myLinkageError Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
	...
	@Override public boolean equals(Object other){
        ...
        myLinkageError otherObj = (myLinkageError) other;
        ...
        try{
            for(Field field:getClass().getFields()){
                ...
                Log.v("compare myLinkageError Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
                Log.v("compare myLinkageError Field",fieldThisValue+"---"+fieldOtherValue);
