...
public class myFloatArrayEvaluator extends FloatArrayEvaluator implements Cloneable {
	public myFloatArrayEvaluator(){super();}
	public myFloatArrayEvaluator(float[] Z1piNkBJLQ){super(Z1piNkBJLQ);}

	private ArrayList compareFields = new ArrayList();

	public myFloatArrayEvaluator clone() throws CloneNotSupportedException{
		myFloatArrayEvaluator cloned = (myFloatArrayEvaluator) super.clone();//浅克隆，克隆基本类型的字段
		...
		try {
    		for(Field field: fieldArr){//该类所有的public字段
				...
				Log.v("clone myFloatArrayEvaluator Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
	...
	@Override public boolean equals(Object other){
        ...
        myFloatArrayEvaluator otherObj = (myFloatArrayEvaluator) other;
        ...
        try{
            for(Field field:getClass().getFields()){
                ...
                Log.v("compare myFloatArrayEvaluator Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
                Log.v("compare myFloatArrayEvaluator Field",fieldThisValue+"---"+fieldOtherValue);
