...
public class myMalformedParameterizedTypeException extends MalformedParameterizedTypeException implements Cloneable {
	public myMalformedParameterizedTypeException(){super();}

	private ArrayList compareFields = new ArrayList();

	public myMalformedParameterizedTypeException clone() throws CloneNotSupportedException{
		myMalformedParameterizedTypeException cloned = (myMalformedParameterizedTypeException) super.clone();//浅克隆，克隆基本类型的字段
		...
		try {
    		for(Field field: fieldArr){//该类所有的public字段
				...
				Log.v("clone myMalformedParameterizedTypeException Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
	...
	@Override public boolean equals(Object other){
        ...
        myMalformedParameterizedTypeException otherObj = (myMalformedParameterizedTypeException) other;
        ...
        try{
            for(Field field:getClass().getFields()){
                ...
                Log.v("compare myMalformedParameterizedTypeException Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
                Log.v("compare myMalformedParameterizedTypeException Field",fieldThisValue+"---"+fieldOtherValue);
