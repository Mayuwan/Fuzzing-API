...
public class myInheritableThreadLocal extends InheritableThreadLocal implements Cloneable {
	public myInheritableThreadLocal(){super();}

	private ArrayList compareFields = new ArrayList();

	public myInheritableThreadLocal clone() throws CloneNotSupportedException{
		myInheritableThreadLocal cloned = (myInheritableThreadLocal) super.clone();//浅克隆，克隆基本类型的字段
		...
		try {
    		for(Field field: fieldArr){//该类所有的public字段
				...
				Log.v("clone myInheritableThreadLocal Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
	...
	@Override public boolean equals(Object other){
        ...
        myInheritableThreadLocal otherObj = (myInheritableThreadLocal) other;
        ...
        try{
            for(Field field:getClass().getFields()){
                ...
                Log.v("compare myInheritableThreadLocal Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
                Log.v("compare myInheritableThreadLocal Field",fieldThisValue+"---"+fieldOtherValue);
