...
public class myLambdaConversionException extends LambdaConversionException implements Cloneable {
	public myLambdaConversionException(){super();}
	public myLambdaConversionException(java.lang.String FJGSpltwIn){super(FJGSpltwIn);}
	public myLambdaConversionException(java.lang.String MxG5YHVBeK, java.lang.Throwable Xm7XJHcBnV){super(MxG5YHVBeK, Xm7XJHcBnV);}
	public myLambdaConversionException(java.lang.Throwable XV5TuQbfpm){super(XV5TuQbfpm);}
	public myLambdaConversionException(java.lang.String OGTfUWvGJB, java.lang.Throwable CIvrivddBx, boolean Obtvej72SZ, boolean D9ELkis1CV){super(OGTfUWvGJB, CIvrivddBx, Obtvej72SZ, D9ELkis1CV);}

	private ArrayList compareFields = new ArrayList();

	public myLambdaConversionException clone() throws CloneNotSupportedException{
		myLambdaConversionException cloned = (myLambdaConversionException) super.clone();//浅克隆，克隆基本类型的字段
		...
		try {
    		for(Field field: fieldArr){//该类所有的public字段
				...
				Log.v("clone myLambdaConversionException Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
	...
	@Override public boolean equals(Object other){
        ...
        myLambdaConversionException otherObj = (myLambdaConversionException) other;
        ...
        try{
            for(Field field:getClass().getFields()){
                ...
                Log.v("compare myLambdaConversionException Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
                Log.v("compare myLambdaConversionException Field",fieldThisValue+"---"+fieldOtherValue);
