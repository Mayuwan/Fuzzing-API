...
public class myIntArrayEvaluator extends IntArrayEvaluator implements Cloneable {
	public myIntArrayEvaluator(){super();}
	public myIntArrayEvaluator(int[] KSAZlNbDKM){super(KSAZlNbDKM);}

	private ArrayList compareFields = new ArrayList();

	public myIntArrayEvaluator clone() throws CloneNotSupportedException{
		myIntArrayEvaluator cloned = (myIntArrayEvaluator) super.clone();//浅克隆，克隆基本类型的字段
		...
		try {
    		for(Field field: fieldArr){//该类所有的public字段
				...
				Log.v("clone myIntArrayEvaluator Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
	...
	@Override public boolean equals(Object other){
        ...
        myIntArrayEvaluator otherObj = (myIntArrayEvaluator) other;
        ...
        try{
            for(Field field:getClass().getFields()){
                ...
                Log.v("compare myIntArrayEvaluator Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
                Log.v("compare myIntArrayEvaluator Field",fieldThisValue+"---"+fieldOtherValue);
