...
public class myResolveInfo extends ResolveInfo implements Cloneable {
	public myResolveInfo(){super();}
	public myResolveInfo(android.content.pm.ResolveInfo IWESfLL5Gz){super(IWESfLL5Gz);}

	private ArrayList compareFields = new ArrayList();

	public myResolveInfo clone() throws CloneNotSupportedException{
		myResolveInfo cloned = (myResolveInfo) super.clone();//浅克隆，克隆基本类型的字段
		...
		try {
    		for(Field field: fieldArr){//该类所有的public字段
				...
				Log.v("clone myResolveInfo Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
	...
	@Override public boolean equals(Object other){
        ...
        myResolveInfo otherObj = (myResolveInfo) other;
        ...
        try{
            for(Field field:getClass().getFields()){
                ...
                Log.v("compare myResolveInfo Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
                Log.v("compare myResolveInfo Field",fieldThisValue+"---"+fieldOtherValue);
