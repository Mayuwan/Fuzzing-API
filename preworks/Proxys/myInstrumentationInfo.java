...
public class myInstrumentationInfo extends InstrumentationInfo implements Cloneable {
	public myInstrumentationInfo(){super();}
	public myInstrumentationInfo(android.content.pm.InstrumentationInfo FbwMHkJFfm){super(FbwMHkJFfm);}

	private ArrayList compareFields = new ArrayList();

	public myInstrumentationInfo clone() throws CloneNotSupportedException{
		myInstrumentationInfo cloned = (myInstrumentationInfo) super.clone();//浅克隆，克隆基本类型的字段
		...
		try {
    		for(Field field: fieldArr){//该类所有的public字段
				...
				Log.v("clone myInstrumentationInfo Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
	...
	@Override public boolean equals(Object other){
        ...
        myInstrumentationInfo otherObj = (myInstrumentationInfo) other;
        ...
        try{
            for(Field field:getClass().getFields()){
                ...
                Log.v("compare myInstrumentationInfo Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
                Log.v("compare myInstrumentationInfo Field",fieldThisValue+"---"+fieldOtherValue);
