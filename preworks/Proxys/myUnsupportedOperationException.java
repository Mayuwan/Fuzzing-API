...
public class myUnsupportedOperationException extends UnsupportedOperationException implements Cloneable {
	public myUnsupportedOperationException(){super();}
	public myUnsupportedOperationException(java.lang.String OysnosNpnY){super(OysnosNpnY);}
	public myUnsupportedOperationException(java.lang.String GAvJTSnbqs, java.lang.Throwable BJMHWXWNZv){super(GAvJTSnbqs, BJMHWXWNZv);}
	public myUnsupportedOperationException(java.lang.Throwable P859dSFKO1){super(P859dSFKO1);}

	private ArrayList compareFields = new ArrayList();

	public myUnsupportedOperationException clone() throws CloneNotSupportedException{
		myUnsupportedOperationException cloned = (myUnsupportedOperationException) super.clone();//浅克隆，克隆基本类型的字段
		...
		try {
    		for(Field field: fieldArr){//该类所有的public字段
				...
				Log.v("clone myUnsupportedOperationException Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
	...
	@Override public boolean equals(Object other){
        ...
        myUnsupportedOperationException otherObj = (myUnsupportedOperationException) other;
        ...
        try{
            for(Field field:getClass().getFields()){
                ...
                Log.v("compare myUnsupportedOperationException Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
                Log.v("compare myUnsupportedOperationException Field",fieldThisValue+"---"+fieldOtherValue);
