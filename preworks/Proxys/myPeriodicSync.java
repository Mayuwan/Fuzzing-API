...
public class myPeriodicSync extends PeriodicSync implements Cloneable {
	public myPeriodicSync(android.accounts.Account SrbR8n2Ojo, java.lang.String XUFJ5y4ZIe, android.os.Bundle MaOxWskogF, long SDEqam5pV8){super(SrbR8n2Ojo, XUFJ5y4ZIe, MaOxWskogF, SDEqam5pV8);}

	private ArrayList compareFields = new ArrayList();

	public myPeriodicSync clone() throws CloneNotSupportedException{
		myPeriodicSync cloned = (myPeriodicSync) super.clone();//浅克隆，克隆基本类型的字段
		...
		try {
    		for(Field field: fieldArr){//该类所有的public字段
				...
				Log.v("clone myPeriodicSync Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
