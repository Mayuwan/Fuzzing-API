...
public class myCloneNotSupportedException extends CloneNotSupportedException implements Cloneable {
	public myCloneNotSupportedException(){super();}
	public myCloneNotSupportedException(java.lang.String NY0dPixYFG){super(NY0dPixYFG);}

	private ArrayList compareFields = new ArrayList();

	public myCloneNotSupportedException clone() throws CloneNotSupportedException{
		myCloneNotSupportedException cloned = (myCloneNotSupportedException) super.clone();//浅克隆，克隆基本类型的字段
		...
		try {
    		for(Field field: fieldArr){//该类所有的public字段
				...
				Log.v("clone myCloneNotSupportedException Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
	...
	@Override public boolean equals(Object other){
        ...
        myCloneNotSupportedException otherObj = (myCloneNotSupportedException) other;
        ...
        try{
            for(Field field:getClass().getFields()){
                ...
                Log.v("compare myCloneNotSupportedException Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
                Log.v("compare myCloneNotSupportedException Field",fieldThisValue+"---"+fieldOtherValue);
