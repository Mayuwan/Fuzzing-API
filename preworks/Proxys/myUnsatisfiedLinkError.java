...
public class myUnsatisfiedLinkError extends UnsatisfiedLinkError implements Cloneable {
	public myUnsatisfiedLinkError(){super();}
	public myUnsatisfiedLinkError(java.lang.String WsdwxhnbNC){super(WsdwxhnbNC);}

	private ArrayList compareFields = new ArrayList();

	public myUnsatisfiedLinkError clone() throws CloneNotSupportedException{
		myUnsatisfiedLinkError cloned = (myUnsatisfiedLinkError) super.clone();//浅克隆，克隆基本类型的字段
		...
		try {
    		for(Field field: fieldArr){//该类所有的public字段
				...
				Log.v("clone myUnsatisfiedLinkError Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
	...
	@Override public boolean equals(Object other){
        ...
        myUnsatisfiedLinkError otherObj = (myUnsatisfiedLinkError) other;
        ...
        try{
            for(Field field:getClass().getFields()){
                ...
                Log.v("compare myUnsatisfiedLinkError Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
                Log.v("compare myUnsatisfiedLinkError Field",fieldThisValue+"---"+fieldOtherValue);
