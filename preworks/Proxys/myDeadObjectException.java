...
public class myDeadObjectException extends DeadObjectException implements Cloneable {
	public myDeadObjectException(){super();}
	public myDeadObjectException(java.lang.String ZgHM3HZOmX){super(ZgHM3HZOmX);}

	private ArrayList compareFields = new ArrayList();

	public myDeadObjectException clone() throws CloneNotSupportedException{
		myDeadObjectException cloned = (myDeadObjectException) super.clone();//浅克隆，克隆基本类型的字段
		...
		try {
    		for(Field field: fieldArr){//该类所有的public字段
				...
				Log.v("clone myDeadObjectException Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
	...
	@Override public boolean equals(Object other){
        ...
        myDeadObjectException otherObj = (myDeadObjectException) other;
        ...
        try{
            for(Field field:getClass().getFields()){
                ...
                Log.v("compare myDeadObjectException Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
                Log.v("compare myDeadObjectException Field",fieldThisValue+"---"+fieldOtherValue);
