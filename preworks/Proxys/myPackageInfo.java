...
public class myPackageInfo extends PackageInfo implements Cloneable {
	public myPackageInfo(){super();}

	private ArrayList compareFields = new ArrayList();

	public myPackageInfo clone() throws CloneNotSupportedException{
		myPackageInfo cloned = (myPackageInfo) super.clone();//浅克隆，克隆基本类型的字段
		...
		try {
    		for(Field field: fieldArr){//该类所有的public字段
				...
				Log.v("clone myPackageInfo Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
	...
	@Override public boolean equals(Object other){
        ...
        myPackageInfo otherObj = (myPackageInfo) other;
        ...
        try{
            for(Field field:getClass().getFields()){
                ...
                Log.v("compare myPackageInfo Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
                Log.v("compare myPackageInfo Field",fieldThisValue+"---"+fieldOtherValue);
