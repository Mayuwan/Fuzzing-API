...
public class myModifier extends Modifier implements Cloneable {
	public myModifier(){super();}

	private ArrayList compareFields = new ArrayList();

	public myModifier clone() throws CloneNotSupportedException{
		myModifier cloned = (myModifier) super.clone();//浅克隆，克隆基本类型的字段
		...
		try {
    		for(Field field: fieldArr){//该类所有的public字段
				...
				Log.v("clone myModifier Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
	...
	@Override public boolean equals(Object other){
        ...
        myModifier otherObj = (myModifier) other;
        ...
        try{
            for(Field field:getClass().getFields()){
                ...
                Log.v("compare myModifier Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
                Log.v("compare myModifier Field",fieldThisValue+"---"+fieldOtherValue);
