...
public class myClassCastException extends ClassCastException implements Cloneable {
	public myClassCastException(){super();}
	public myClassCastException(java.lang.String EgwdxhHkoq){super(EgwdxhHkoq);}

	private ArrayList compareFields = new ArrayList();

	public myClassCastException clone() throws CloneNotSupportedException{
		myClassCastException cloned = (myClassCastException) super.clone();//浅克隆，克隆基本类型的字段
		...
		try {
    		for(Field field: fieldArr){//该类所有的public字段
				...
				Log.v("clone myClassCastException Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
	...
	@Override public boolean equals(Object other){
        ...
        myClassCastException otherObj = (myClassCastException) other;
        ...
        try{
            for(Field field:getClass().getFields()){
                ...
                Log.v("compare myClassCastException Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
                Log.v("compare myClassCastException Field",fieldThisValue+"---"+fieldOtherValue);
