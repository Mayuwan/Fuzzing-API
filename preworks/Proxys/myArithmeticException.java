...
public class myArithmeticException extends ArithmeticException implements Cloneable {
	public myArithmeticException(){super();}
	public myArithmeticException(java.lang.String BqDmPd6G8o){super(BqDmPd6G8o);}

	private ArrayList compareFields = new ArrayList();

	public myArithmeticException clone() throws CloneNotSupportedException{
		myArithmeticException cloned = (myArithmeticException) super.clone();//浅克隆，克隆基本类型的字段
		...
		try {
    		for(Field field: fieldArr){//该类所有的public字段
				...
				Log.v("clone myArithmeticException Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
	...
	@Override public boolean equals(Object other){
        ...
        myArithmeticException otherObj = (myArithmeticException) other;
        ...
        try{
            for(Field field:getClass().getFields()){
                ...
                Log.v("compare myArithmeticException Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
                Log.v("compare myArithmeticException Field",fieldThisValue+"---"+fieldOtherValue);
