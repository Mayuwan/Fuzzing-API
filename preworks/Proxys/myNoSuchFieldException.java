...
public class myNoSuchFieldException extends NoSuchFieldException implements Cloneable {
	public myNoSuchFieldException(){super();}
	public myNoSuchFieldException(java.lang.String HQU21F6FQT){super(HQU21F6FQT);}

	private ArrayList compareFields = new ArrayList();

	public myNoSuchFieldException clone() throws CloneNotSupportedException{
		myNoSuchFieldException cloned = (myNoSuchFieldException) super.clone();//浅克隆，克隆基本类型的字段
		...
		try {
    		for(Field field: fieldArr){//该类所有的public字段
				...
				Log.v("clone myNoSuchFieldException Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
	...
	@Override public boolean equals(Object other){
        ...
        myNoSuchFieldException otherObj = (myNoSuchFieldException) other;
        ...
        try{
            for(Field field:getClass().getFields()){
                ...
                Log.v("compare myNoSuchFieldException Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
                Log.v("compare myNoSuchFieldException Field",fieldThisValue+"---"+fieldOtherValue);
