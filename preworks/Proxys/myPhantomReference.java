...
public class myPhantomReference extends PhantomReference implements Cloneable {
	public myPhantomReference(java.lang.Object GLMSuc2R5A, java.lang.ref.ReferenceQueue TGmjOrA24T){super(GLMSuc2R5A, TGmjOrA24T);}

	private ArrayList compareFields = new ArrayList();

	public myPhantomReference clone() throws CloneNotSupportedException{
		myPhantomReference cloned = (myPhantomReference) super.clone();//浅克隆，克隆基本类型的字段
		...
		try {
    		for(Field field: fieldArr){//该类所有的public字段
				...
				Log.v("clone myPhantomReference Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
	...
	@Override public boolean equals(Object other){
        ...
        myPhantomReference otherObj = (myPhantomReference) other;
        ...
        try{
            for(Field field:getClass().getFields()){
                ...
                Log.v("compare myPhantomReference Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
                Log.v("compare myPhantomReference Field",fieldThisValue+"---"+fieldOtherValue);
