...
public class myAssetFileDescriptor extends AssetFileDescriptor implements Cloneable {
	public myAssetFileDescriptor(android.os.ParcelFileDescriptor XrM1UBAzOP, long NWUNR6suYv, long NGwBEXyJxU){super(XrM1UBAzOP, NWUNR6suYv, NGwBEXyJxU);}
	public myAssetFileDescriptor(android.os.ParcelFileDescriptor PxcEyUuQnY, long Mftuj5Z7ng, long MkWLoEcfYP, android.os.Bundle EkA9z5Wj1R){super(PxcEyUuQnY, Mftuj5Z7ng, MkWLoEcfYP, EkA9z5Wj1R);}

	private ArrayList compareFields = new ArrayList();

	public myAssetFileDescriptor clone() throws CloneNotSupportedException{
		myAssetFileDescriptor cloned = (myAssetFileDescriptor) super.clone();//浅克隆，克隆基本类型的字段
		...
		try {
    		for(Field field: fieldArr){//该类所有的public字段
				...
				Log.v("clone myAssetFileDescriptor Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
	...
	@Override public boolean equals(Object other){
        ...
        myAssetFileDescriptor otherObj = (myAssetFileDescriptor) other;
        ...
        try{
            for(Field field:getClass().getFields()){
                ...
                Log.v("compare myAssetFileDescriptor Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
                Log.v("compare myAssetFileDescriptor Field",fieldThisValue+"---"+fieldOtherValue);
