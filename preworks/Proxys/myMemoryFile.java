...
public class myMemoryFile extends MemoryFile implements Cloneable {
	public myMemoryFile(java.lang.String G0yk2XkV0G, int IQ7yb5sLVv){super(G0yk2XkV0G, IQ7yb5sLVv);}

	private ArrayList compareFields = new ArrayList();

	public myMemoryFile clone() throws CloneNotSupportedException{
		myMemoryFile cloned = (myMemoryFile) super.clone();//浅克隆，克隆基本类型的字段
		...
		try {
    		for(Field field: fieldArr){//该类所有的public字段
				...
				Log.v("clone myMemoryFile Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
	...
	@Override public boolean equals(Object other){
        ...
        myMemoryFile otherObj = (myMemoryFile) other;
        ...
        try{
            for(Field field:getClass().getFields()){
                ...
                Log.v("compare myMemoryFile Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
                Log.v("compare myMemoryFile Field",fieldThisValue+"---"+fieldOtherValue);
