...
public class myArrayStoreException extends ArrayStoreException implements Cloneable {
	public myArrayStoreException(){super();}
	public myArrayStoreException(java.lang.String RB7IkFDoJT){super(RB7IkFDoJT);}

	private ArrayList compareFields = new ArrayList();

	public myArrayStoreException clone() throws CloneNotSupportedException{
		myArrayStoreException cloned = (myArrayStoreException) super.clone();//浅克隆，克隆基本类型的字段
		...
		try {
    		for(Field field: fieldArr){//该类所有的public字段
				...
				Log.v("clone myArrayStoreException Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
	...
	@Override public boolean equals(Object other){
        ...
        myArrayStoreException otherObj = (myArrayStoreException) other;
        ...
        try{
            for(Field field:getClass().getFields()){
                ...
                Log.v("compare myArrayStoreException Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
                Log.v("compare myArrayStoreException Field",fieldThisValue+"---"+fieldOtherValue);
