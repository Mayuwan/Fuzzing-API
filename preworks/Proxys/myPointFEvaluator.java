...
public class myPointFEvaluator extends PointFEvaluator implements Cloneable {
	public myPointFEvaluator(){super();}
	public myPointFEvaluator(android.graphics.PointF Arlafq6AqQ){super(Arlafq6AqQ);}

	private ArrayList compareFields = new ArrayList();

	public myPointFEvaluator clone() throws CloneNotSupportedException{
		myPointFEvaluator cloned = (myPointFEvaluator) super.clone();//浅克隆，克隆基本类型的字段
		...
		try {
    		for(Field field: fieldArr){//该类所有的public字段
				...
				Log.v("clone myPointFEvaluator Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
	...
	@Override public boolean equals(Object other){
        ...
        myPointFEvaluator otherObj = (myPointFEvaluator) other;
        ...
        try{
            for(Field field:getClass().getFields()){
                ...
                Log.v("compare myPointFEvaluator Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
                Log.v("compare myPointFEvaluator Field",fieldThisValue+"---"+fieldOtherValue);
