...
public class myEnvironment extends Environment implements Cloneable {
	public myEnvironment(){super();}

	private ArrayList compareFields = new ArrayList();

	public myEnvironment clone() throws CloneNotSupportedException{
		myEnvironment cloned = (myEnvironment) super.clone();//浅克隆，克隆基本类型的字段
		...
		try {
    		for(Field field: fieldArr){//该类所有的public字段
				...
				Log.v("clone myEnvironment Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
	...
	@Override public boolean equals(Object other){
        ...
        myEnvironment otherObj = (myEnvironment) other;
        ...
        try{
            for(Field field:getClass().getFields()){
                ...
                Log.v("compare myEnvironment Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
                Log.v("compare myEnvironment Field",fieldThisValue+"---"+fieldOtherValue);
