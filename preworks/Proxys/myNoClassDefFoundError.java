...
public class myNoClassDefFoundError extends NoClassDefFoundError implements Cloneable {
	public myNoClassDefFoundError(){super();}
	public myNoClassDefFoundError(java.lang.String Bbqz2B0ghh){super(Bbqz2B0ghh);}

	private ArrayList compareFields = new ArrayList();

	public myNoClassDefFoundError clone() throws CloneNotSupportedException{
		myNoClassDefFoundError cloned = (myNoClassDefFoundError) super.clone();//浅克隆，克隆基本类型的字段
		...
		try {
    		for(Field field: fieldArr){//该类所有的public字段
				...
				Log.v("clone myNoClassDefFoundError Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
	...
	@Override public boolean equals(Object other){
        ...
        myNoClassDefFoundError otherObj = (myNoClassDefFoundError) other;
        ...
        try{
            for(Field field:getClass().getFields()){
                ...
                Log.v("compare myNoClassDefFoundError Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
                Log.v("compare myNoClassDefFoundError Field",fieldThisValue+"---"+fieldOtherValue);
