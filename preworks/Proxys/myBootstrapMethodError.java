...
public class myBootstrapMethodError extends BootstrapMethodError implements Cloneable {
	public myBootstrapMethodError(){super();}
	public myBootstrapMethodError(java.lang.String CGI8xBzDzR){super(CGI8xBzDzR);}
	public myBootstrapMethodError(java.lang.String BUlPEhatU7, java.lang.Throwable RWCYiVxSoh){super(BUlPEhatU7, RWCYiVxSoh);}
	public myBootstrapMethodError(java.lang.Throwable PujJO1LizF){super(PujJO1LizF);}

	private ArrayList compareFields = new ArrayList();

	public myBootstrapMethodError clone() throws CloneNotSupportedException{
		myBootstrapMethodError cloned = (myBootstrapMethodError) super.clone();//浅克隆，克隆基本类型的字段
		...
		try {
    		for(Field field: fieldArr){//该类所有的public字段
				...
				Log.v("clone myBootstrapMethodError Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
	...
	@Override public boolean equals(Object other){
        ...
        myBootstrapMethodError otherObj = (myBootstrapMethodError) other;
        ...
        try{
            for(Field field:getClass().getFields()){
                ...
                Log.v("compare myBootstrapMethodError Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
                Log.v("compare myBootstrapMethodError Field",fieldThisValue+"---"+fieldOtherValue);
