...
public class myInternalError extends InternalError implements Cloneable {
	public myInternalError(){super();}
	public myInternalError(java.lang.String GvcvQZOi7i){super(GvcvQZOi7i);}
	public myInternalError(java.lang.String S1flfxRJHC, java.lang.Throwable BD3WtpYWNA){super(S1flfxRJHC, BD3WtpYWNA);}
	public myInternalError(java.lang.Throwable QdncH8u9CR){super(QdncH8u9CR);}

	private ArrayList compareFields = new ArrayList();

	public myInternalError clone() throws CloneNotSupportedException{
		myInternalError cloned = (myInternalError) super.clone();//浅克隆，克隆基本类型的字段
		...
		try {
    		for(Field field: fieldArr){//该类所有的public字段
				...
				Log.v("clone myInternalError Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
	...
	@Override public boolean equals(Object other){
        ...
        myInternalError otherObj = (myInternalError) other;
        ...
        try{
            for(Field field:getClass().getFields()){
                ...
                Log.v("compare myInternalError Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
                Log.v("compare myInternalError Field",fieldThisValue+"---"+fieldOtherValue);
