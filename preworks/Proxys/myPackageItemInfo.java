...
public class myPackageItemInfo extends PackageItemInfo implements Cloneable {
	public myPackageItemInfo(){super();}
	public myPackageItemInfo(android.content.pm.PackageItemInfo D8HLJmWD33){super(D8HLJmWD33);}
	protected myPackageItemInfo(android.os.Parcel DvdecZyb6G){super(DvdecZyb6G);}

	private ArrayList compareFields = new ArrayList();

	public myPackageItemInfo clone() throws CloneNotSupportedException{
		myPackageItemInfo cloned = (myPackageItemInfo) super.clone();//浅克隆，克隆基本类型的字段
		...
		try {
    		for(Field field: fieldArr){//该类所有的public字段
				...
				Log.v("clone myPackageItemInfo Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
	...
	@Override public boolean equals(Object other){
        ...
        myPackageItemInfo otherObj = (myPackageItemInfo) other;
        ...
        try{
            for(Field field:getClass().getFields()){
                ...
                Log.v("compare myPackageItemInfo Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
                Log.v("compare myPackageItemInfo Field",fieldThisValue+"---"+fieldOtherValue);
