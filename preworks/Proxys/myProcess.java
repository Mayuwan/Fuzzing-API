...
public class myProcess extends Process implements Cloneable {
	public myProcess(){super();}

	private ArrayList compareFields = new ArrayList();

	public myProcess clone() throws CloneNotSupportedException{
		myProcess cloned = (myProcess) super.clone();//浅克隆，克隆基本类型的字段
		...
		try {
    		for(Field field: fieldArr){//该类所有的public字段
				...
				Log.v("clone myProcess Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
	...
	@Override public boolean equals(Object other){
        ...
        myProcess otherObj = (myProcess) other;
        ...
        try{
            for(Field field:getClass().getFields()){
                ...
                Log.v("compare myProcess Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
                Log.v("compare myProcess Field",fieldThisValue+"---"+fieldOtherValue);
