...
public class mySearchRecentSuggestionsProvider extends SearchRecentSuggestionsProvider implements Cloneable {
	public mySearchRecentSuggestionsProvider(){super();}

	private ArrayList compareFields = new ArrayList();

	public mySearchRecentSuggestionsProvider clone() throws CloneNotSupportedException{
		mySearchRecentSuggestionsProvider cloned = (mySearchRecentSuggestionsProvider) super.clone();//浅克隆，克隆基本类型的字段
		...
		try {
    		for(Field field: fieldArr){//该类所有的public字段
				...
				Log.v("clone mySearchRecentSuggestionsProvider Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
	...
	@Override public boolean equals(Object other){
        ...
        mySearchRecentSuggestionsProvider otherObj = (mySearchRecentSuggestionsProvider) other;
        ...
        try{
            for(Field field:getClass().getFields()){
                ...
                Log.v("compare mySearchRecentSuggestionsProvider Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
                Log.v("compare mySearchRecentSuggestionsProvider Field",fieldThisValue+"---"+fieldOtherValue);
