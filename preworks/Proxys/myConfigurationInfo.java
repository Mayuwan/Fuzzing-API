...
public class myConfigurationInfo extends ConfigurationInfo implements Cloneable {
	public myConfigurationInfo(){super();}
	public myConfigurationInfo(android.content.pm.ConfigurationInfo M5ekuSGMTY){super(M5ekuSGMTY);}

	private ArrayList compareFields = new ArrayList();

	public myConfigurationInfo clone() throws CloneNotSupportedException{
		myConfigurationInfo cloned = (myConfigurationInfo) super.clone();//浅克隆，克隆基本类型的字段
		...
		try {
    		for(Field field: fieldArr){//该类所有的public字段
				...
				Log.v("clone myConfigurationInfo Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
	...
	@Override public boolean equals(Object other){
        ...
        myConfigurationInfo otherObj = (myConfigurationInfo) other;
        ...
        try{
            for(Field field:getClass().getFields()){
                ...
                Log.v("compare myConfigurationInfo Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
                Log.v("compare myConfigurationInfo Field",fieldThisValue+"---"+fieldOtherValue);
