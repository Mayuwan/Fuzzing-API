...
public class myClassNotFoundException extends ClassNotFoundException implements Cloneable {
	public myClassNotFoundException(){super();}
	public myClassNotFoundException(java.lang.String B9ETiZz6X9){super(B9ETiZz6X9);}
	public myClassNotFoundException(java.lang.String TqdVEgK703, java.lang.Throwable IoVdhzxqQy){super(TqdVEgK703, IoVdhzxqQy);}

	private ArrayList compareFields = new ArrayList();

	public myClassNotFoundException clone() throws CloneNotSupportedException{
		myClassNotFoundException cloned = (myClassNotFoundException) super.clone();//浅克隆，克隆基本类型的字段
		...
		try {
    		for(Field field: fieldArr){//该类所有的public字段
				...
				Log.v("clone myClassNotFoundException Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
	...
	@Override public boolean equals(Object other){
        ...
        myClassNotFoundException otherObj = (myClassNotFoundException) other;
        ...
        try{
            for(Field field:getClass().getFields()){
                ...
                Log.v("compare myClassNotFoundException Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
                Log.v("compare myClassNotFoundException Field",fieldThisValue+"---"+fieldOtherValue);
