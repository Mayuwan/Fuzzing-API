...
public class myConditionVariable extends ConditionVariable implements Cloneable {
	public myConditionVariable(){super();}
	public myConditionVariable(boolean YZ6jd1dtmh){super(YZ6jd1dtmh);}

	private ArrayList compareFields = new ArrayList();

	public myConditionVariable clone() throws CloneNotSupportedException{
		myConditionVariable cloned = (myConditionVariable) super.clone();//浅克隆，克隆基本类型的字段
		...
		try {
    		for(Field field: fieldArr){//该类所有的public字段
				...
				Log.v("clone myConditionVariable Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
	...
	@Override public boolean equals(Object other){
        ...
        myConditionVariable otherObj = (myConditionVariable) other;
        ...
        try{
            for(Field field:getClass().getFields()){
                ...
                Log.v("compare myConditionVariable Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
                Log.v("compare myConditionVariable Field",fieldThisValue+"---"+fieldOtherValue);
