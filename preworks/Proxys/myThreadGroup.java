...
public class myThreadGroup extends ThreadGroup implements Cloneable {
	public myThreadGroup(java.lang.String TIAO2HAb6J){super(TIAO2HAb6J);}
	public myThreadGroup(java.lang.ThreadGroup AyfIh7d1ZE, java.lang.String N2JMhv8PLr){super(AyfIh7d1ZE, N2JMhv8PLr);}

	private ArrayList compareFields = new ArrayList();

	public myThreadGroup clone() throws CloneNotSupportedException{
		myThreadGroup cloned = (myThreadGroup) super.clone();//浅克隆，克隆基本类型的字段
		...
		try {
    		for(Field field: fieldArr){//该类所有的public字段
				...
				Log.v("clone myThreadGroup Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
	...
	@Override public boolean equals(Object other){
        ...
        myThreadGroup otherObj = (myThreadGroup) other;
        ...
        try{
            for(Field field:getClass().getFields()){
                ...
                Log.v("compare myThreadGroup Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
                Log.v("compare myThreadGroup Field",fieldThisValue+"---"+fieldOtherValue);
