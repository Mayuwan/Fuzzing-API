...
public class myTypeNotPresentException extends TypeNotPresentException implements Cloneable {
	public myTypeNotPresentException(java.lang.String L2kw8WbWzZ, java.lang.Throwable KARUbaWU8P){super(L2kw8WbWzZ, KARUbaWU8P);}

	private ArrayList compareFields = new ArrayList();

	public myTypeNotPresentException clone() throws CloneNotSupportedException{
		myTypeNotPresentException cloned = (myTypeNotPresentException) super.clone();//浅克隆，克隆基本类型的字段
		...
		try {
    		for(Field field: fieldArr){//该类所有的public字段
				...
				Log.v("clone myTypeNotPresentException Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
	...
	@Override public boolean equals(Object other){
        ...
        myTypeNotPresentException otherObj = (myTypeNotPresentException) other;
        ...
        try{
            for(Field field:getClass().getFields()){
                ...
                Log.v("compare myTypeNotPresentException Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
                Log.v("compare myTypeNotPresentException Field",fieldThisValue+"---"+fieldOtherValue);
