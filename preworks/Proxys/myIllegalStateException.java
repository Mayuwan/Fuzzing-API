...
public class myIllegalStateException extends IllegalStateException implements Cloneable {
	public myIllegalStateException(){super();}
	public myIllegalStateException(java.lang.String WLcuhVFcH1){super(WLcuhVFcH1);}
	public myIllegalStateException(java.lang.String OM6gqLpPpS, java.lang.Throwable Bj5QT2HJTV){super(OM6gqLpPpS, Bj5QT2HJTV);}
	public myIllegalStateException(java.lang.Throwable VhbdwBXuDa){super(VhbdwBXuDa);}

	private ArrayList compareFields = new ArrayList();

	public myIllegalStateException clone() throws CloneNotSupportedException{
		myIllegalStateException cloned = (myIllegalStateException) super.clone();//浅克隆，克隆基本类型的字段
		...
		try {
    		for(Field field: fieldArr){//该类所有的public字段
				...
				Log.v("clone myIllegalStateException Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
	...
	@Override public boolean equals(Object other){
        ...
        myIllegalStateException otherObj = (myIllegalStateException) other;
        ...
        try{
            for(Field field:getClass().getFields()){
                ...
                Log.v("compare myIllegalStateException Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
                Log.v("compare myIllegalStateException Field",fieldThisValue+"---"+fieldOtherValue);
