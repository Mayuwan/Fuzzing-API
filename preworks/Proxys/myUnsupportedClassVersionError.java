...
public class myUnsupportedClassVersionError extends UnsupportedClassVersionError implements Cloneable {
	public myUnsupportedClassVersionError(){super();}
	public myUnsupportedClassVersionError(java.lang.String YxBdeiubsP){super(YxBdeiubsP);}

	private ArrayList compareFields = new ArrayList();

	public myUnsupportedClassVersionError clone() throws CloneNotSupportedException{
		myUnsupportedClassVersionError cloned = (myUnsupportedClassVersionError) super.clone();//浅克隆，克隆基本类型的字段
		...
		try {
    		for(Field field: fieldArr){//该类所有的public字段
				...
				Log.v("clone myUnsupportedClassVersionError Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
	...
	@Override public boolean equals(Object other){
        ...
        myUnsupportedClassVersionError otherObj = (myUnsupportedClassVersionError) other;
        ...
        try{
            for(Field field:getClass().getFields()){
                ...
                Log.v("compare myUnsupportedClassVersionError Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
                Log.v("compare myUnsupportedClassVersionError Field",fieldThisValue+"---"+fieldOtherValue);
