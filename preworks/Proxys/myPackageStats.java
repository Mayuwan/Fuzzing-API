...
public class myPackageStats extends PackageStats implements Cloneable {
	public myPackageStats(java.lang.String EkdLcW5RON){super(EkdLcW5RON);}
	public myPackageStats(android.os.Parcel FQ5ZlVb5vS){super(FQ5ZlVb5vS);}
	public myPackageStats(android.content.pm.PackageStats MfzVi0Ju1t){super(MfzVi0Ju1t);}

	private ArrayList compareFields = new ArrayList();

	public myPackageStats clone() throws CloneNotSupportedException{
		myPackageStats cloned = (myPackageStats) super.clone();//浅克隆，克隆基本类型的字段
		...
		try {
    		for(Field field: fieldArr){//该类所有的public字段
				...
				Log.v("clone myPackageStats Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
