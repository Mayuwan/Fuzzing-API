...
public class myStatFs extends StatFs implements Cloneable {
	public myStatFs(java.lang.String IDQhU1uPrQ){super(IDQhU1uPrQ);}

	private ArrayList compareFields = new ArrayList();

	public myStatFs clone() throws CloneNotSupportedException{
		myStatFs cloned = (myStatFs) super.clone();//浅克隆，克隆基本类型的字段
		...
		try {
    		for(Field field: fieldArr){//该类所有的public字段
				...
				Log.v("clone myStatFs Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
	...
	@Override public boolean equals(Object other){
        ...
        myStatFs otherObj = (myStatFs) other;
        ...
        try{
            for(Field field:getClass().getFields()){
                ...
                Log.v("compare myStatFs Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
                Log.v("compare myStatFs Field",fieldThisValue+"---"+fieldOtherValue);
