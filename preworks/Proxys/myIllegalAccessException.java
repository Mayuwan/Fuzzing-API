...
public class myIllegalAccessException extends IllegalAccessException implements Cloneable {
	public myIllegalAccessException(){super();}
	public myIllegalAccessException(java.lang.String BjgGiKEMj7){super(BjgGiKEMj7);}

	private ArrayList compareFields = new ArrayList();

	public myIllegalAccessException clone() throws CloneNotSupportedException{
		myIllegalAccessException cloned = (myIllegalAccessException) super.clone();//浅克隆，克隆基本类型的字段
		...
		try {
    		for(Field field: fieldArr){//该类所有的public字段
				...
				Log.v("clone myIllegalAccessException Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
	...
	@Override public boolean equals(Object other){
        ...
        myIllegalAccessException otherObj = (myIllegalAccessException) other;
        ...
        try{
            for(Field field:getClass().getFields()){
                ...
                Log.v("compare myIllegalAccessException Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
                Log.v("compare myIllegalAccessException Field",fieldThisValue+"---"+fieldOtherValue);
