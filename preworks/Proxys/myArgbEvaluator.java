...
public class myArgbEvaluator extends ArgbEvaluator implements Cloneable {
	public myArgbEvaluator(){super();}

	private ArrayList compareFields = new ArrayList();

	public myArgbEvaluator clone() throws CloneNotSupportedException{
		myArgbEvaluator cloned = (myArgbEvaluator) super.clone();//浅克隆，克隆基本类型的字段
		...
		try {
    		for(Field field: fieldArr){//该类所有的public字段
				...
				Log.v("clone myArgbEvaluator Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
	...
	@Override public boolean equals(Object other){
        ...
        myArgbEvaluator otherObj = (myArgbEvaluator) other;
        ...
        try{
            for(Field field:getClass().getFields()){
                ...
                Log.v("compare myArgbEvaluator Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
                Log.v("compare myArgbEvaluator Field",fieldThisValue+"---"+fieldOtherValue);
