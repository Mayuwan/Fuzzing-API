...
public class myFeatureGroupInfo extends FeatureGroupInfo implements Cloneable {
	public myFeatureGroupInfo(){super();}
	public myFeatureGroupInfo(android.content.pm.FeatureGroupInfo N76RcH48RU){super(N76RcH48RU);}

	private ArrayList compareFields = new ArrayList();

	public myFeatureGroupInfo clone() throws CloneNotSupportedException{
		myFeatureGroupInfo cloned = (myFeatureGroupInfo) super.clone();//浅克隆，克隆基本类型的字段
		...
		try {
    		for(Field field: fieldArr){//该类所有的public字段
				...
				Log.v("clone myFeatureGroupInfo Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
	...
	@Override public boolean equals(Object other){
        ...
        myFeatureGroupInfo otherObj = (myFeatureGroupInfo) other;
        ...
        try{
            for(Field field:getClass().getFields()){
                ...
                Log.v("compare myFeatureGroupInfo Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
                Log.v("compare myFeatureGroupInfo Field",fieldThisValue+"---"+fieldOtherValue);
