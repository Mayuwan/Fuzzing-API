...
public class myInvocationTargetException extends InvocationTargetException implements Cloneable {
	protected myInvocationTargetException(){super();}
	public myInvocationTargetException(java.lang.Throwable ZE3TplaxxA){super(ZE3TplaxxA);}
	public myInvocationTargetException(java.lang.Throwable AGUAgHwmR6, java.lang.String NvOWmOVtVI){super(AGUAgHwmR6, NvOWmOVtVI);}

	private ArrayList compareFields = new ArrayList();

	public myInvocationTargetException clone() throws CloneNotSupportedException{
		myInvocationTargetException cloned = (myInvocationTargetException) super.clone();//浅克隆，克隆基本类型的字段
		...
		try {
    		for(Field field: fieldArr){//该类所有的public字段
				...
				Log.v("clone myInvocationTargetException Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
	...
	@Override public boolean equals(Object other){
        ...
        myInvocationTargetException otherObj = (myInvocationTargetException) other;
        ...
        try{
            for(Field field:getClass().getFields()){
                ...
                Log.v("compare myInvocationTargetException Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
                Log.v("compare myInvocationTargetException Field",fieldThisValue+"---"+fieldOtherValue);
