...
public class myInstantiationException extends InstantiationException implements Cloneable {
	public myInstantiationException(){super();}
	public myInstantiationException(java.lang.String Gg7OQBU1as){super(Gg7OQBU1as);}

	private ArrayList compareFields = new ArrayList();

	public myInstantiationException clone() throws CloneNotSupportedException{
		myInstantiationException cloned = (myInstantiationException) super.clone();//浅克隆，克隆基本类型的字段
		...
		try {
    		for(Field field: fieldArr){//该类所有的public字段
				...
				Log.v("clone myInstantiationException Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
	...
	@Override public boolean equals(Object other){
        ...
        myInstantiationException otherObj = (myInstantiationException) other;
        ...
        try{
            for(Field field:getClass().getFields()){
                ...
                Log.v("compare myInstantiationException Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
                Log.v("compare myInstantiationException Field",fieldThisValue+"---"+fieldOtherValue);
