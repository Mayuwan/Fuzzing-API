...
public class myNullPointerException extends NullPointerException implements Cloneable {
	public myNullPointerException(){super();}
	public myNullPointerException(java.lang.String LVbKDUy5x4){super(LVbKDUy5x4);}

	private ArrayList compareFields = new ArrayList();

	public myNullPointerException clone() throws CloneNotSupportedException{
		myNullPointerException cloned = (myNullPointerException) super.clone();//浅克隆，克隆基本类型的字段
		...
		try {
    		for(Field field: fieldArr){//该类所有的public字段
				...
				Log.v("clone myNullPointerException Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
	...
	@Override public boolean equals(Object other){
        ...
        myNullPointerException otherObj = (myNullPointerException) other;
        ...
        try{
            for(Field field:getClass().getFields()){
                ...
                Log.v("compare myNullPointerException Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
                Log.v("compare myNullPointerException Field",fieldThisValue+"---"+fieldOtherValue);
