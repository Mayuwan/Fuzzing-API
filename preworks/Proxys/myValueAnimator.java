...
public class myValueAnimator extends ValueAnimator implements Cloneable {
	public myValueAnimator(){super();}

	private ArrayList compareFields = new ArrayList();

	public myValueAnimator clone() throws CloneNotSupportedException{
		myValueAnimator cloned = (myValueAnimator) super.clone();//浅克隆，克隆基本类型的字段
		...
		try {
    		for(Field field: fieldArr){//该类所有的public字段
				...
				Log.v("clone myValueAnimator Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
	...
	@Override public boolean equals(Object other){
        ...
        myValueAnimator otherObj = (myValueAnimator) other;
        ...
        try{
            for(Field field:getClass().getFields()){
                ...
                Log.v("compare myValueAnimator Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
                Log.v("compare myValueAnimator Field",fieldThisValue+"---"+fieldOtherValue);
