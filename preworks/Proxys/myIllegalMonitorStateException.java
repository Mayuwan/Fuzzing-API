...
public class myIllegalMonitorStateException extends IllegalMonitorStateException implements Cloneable {
	public myIllegalMonitorStateException(){super();}
	public myIllegalMonitorStateException(java.lang.String TzSTmuKP5h){super(TzSTmuKP5h);}

	private ArrayList compareFields = new ArrayList();

	public myIllegalMonitorStateException clone() throws CloneNotSupportedException{
		myIllegalMonitorStateException cloned = (myIllegalMonitorStateException) super.clone();//浅克隆，克隆基本类型的字段
		...
		try {
    		for(Field field: fieldArr){//该类所有的public字段
				...
				Log.v("clone myIllegalMonitorStateException Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
	...
	@Override public boolean equals(Object other){
        ...
        myIllegalMonitorStateException otherObj = (myIllegalMonitorStateException) other;
        ...
        try{
            for(Field field:getClass().getFields()){
                ...
                Log.v("compare myIllegalMonitorStateException Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
                Log.v("compare myIllegalMonitorStateException Field",fieldThisValue+"---"+fieldOtherValue);
