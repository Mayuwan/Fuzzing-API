...
public class myStackOverflowError extends StackOverflowError implements Cloneable {
	public myStackOverflowError(){super();}
	public myStackOverflowError(java.lang.String QnTqEY4bXA){super(QnTqEY4bXA);}

	private ArrayList compareFields = new ArrayList();

	public myStackOverflowError clone() throws CloneNotSupportedException{
		myStackOverflowError cloned = (myStackOverflowError) super.clone();//浅克隆，克隆基本类型的字段
		...
		try {
    		for(Field field: fieldArr){//该类所有的public字段
				...
				Log.v("clone myStackOverflowError Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
	...
	@Override public boolean equals(Object other){
        ...
        myStackOverflowError otherObj = (myStackOverflowError) other;
        ...
        try{
            for(Field field:getClass().getFields()){
                ...
                Log.v("compare myStackOverflowError Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
                Log.v("compare myStackOverflowError Field",fieldThisValue+"---"+fieldOtherValue);
