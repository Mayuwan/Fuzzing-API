...
public class myAccessibleObject extends AccessibleObject implements Cloneable {
	protected myAccessibleObject(){super();}

	private ArrayList compareFields = new ArrayList();

	public myAccessibleObject clone() throws CloneNotSupportedException{
		myAccessibleObject cloned = (myAccessibleObject) super.clone();//浅克隆，克隆基本类型的字段
		...
		try {
    		for(Field field: fieldArr){//该类所有的public字段
				...
				Log.v("clone myAccessibleObject Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
	...
	@Override public boolean equals(Object other){
        ...
        myAccessibleObject otherObj = (myAccessibleObject) other;
        ...
        try{
            for(Field field:getClass().getFields()){
                ...
                Log.v("compare myAccessibleObject Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
                Log.v("compare myAccessibleObject Field",fieldThisValue+"---"+fieldOtherValue);
