...
public class myDropBoxManager extends DropBoxManager implements Cloneable {
	protected myDropBoxManager(){super();}

	private ArrayList compareFields = new ArrayList();

	public myDropBoxManager clone() throws CloneNotSupportedException{
		myDropBoxManager cloned = (myDropBoxManager) super.clone();//浅克隆，克隆基本类型的字段
		...
		try {
    		for(Field field: fieldArr){//该类所有的public字段
				...
				Log.v("clone myDropBoxManager Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
	...
	@Override public boolean equals(Object other){
        ...
        myDropBoxManager otherObj = (myDropBoxManager) other;
        ...
        try{
            for(Field field:getClass().getFields()){
                ...
                Log.v("compare myDropBoxManager Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
                Log.v("compare myDropBoxManager Field",fieldThisValue+"---"+fieldOtherValue);
