...
public class myRuntimeException extends RuntimeException implements Cloneable {
	public myRuntimeException(){super();}
	public myRuntimeException(java.lang.String M1Fljnx68W){super(M1Fljnx68W);}
	public myRuntimeException(java.lang.String KUd65gNHdQ, java.lang.Throwable XuBPaIP81Y){super(KUd65gNHdQ, XuBPaIP81Y);}
	public myRuntimeException(java.lang.Throwable GxZLxwdmys){super(GxZLxwdmys);}
	protected myRuntimeException(java.lang.String DvArzmdNOS, java.lang.Throwable PATGucN1QQ, boolean UBA0Yx0FDm, boolean Zz0bXAep9b){super(DvArzmdNOS, PATGucN1QQ, UBA0Yx0FDm, Zz0bXAep9b);}

	private ArrayList compareFields = new ArrayList();

	public myRuntimeException clone() throws CloneNotSupportedException{
		myRuntimeException cloned = (myRuntimeException) super.clone();//浅克隆，克隆基本类型的字段
		...
		try {
    		for(Field field: fieldArr){//该类所有的public字段
				...
				Log.v("clone myRuntimeException Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
	...
	@Override public boolean equals(Object other){
        ...
        myRuntimeException otherObj = (myRuntimeException) other;
        ...
        try{
            for(Field field:getClass().getFields()){
                ...
                Log.v("compare myRuntimeException Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
                Log.v("compare myRuntimeException Field",fieldThisValue+"---"+fieldOtherValue);
