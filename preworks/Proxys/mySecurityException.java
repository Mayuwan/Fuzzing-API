...
public class mySecurityException extends SecurityException implements Cloneable {
	public mySecurityException(){super();}
	public mySecurityException(java.lang.String TFiQGTFGOn){super(TFiQGTFGOn);}
	public mySecurityException(java.lang.String HoqFCEPPOV, java.lang.Throwable Wfc7eKzPbC){super(HoqFCEPPOV, Wfc7eKzPbC);}
	public mySecurityException(java.lang.Throwable WLQZepnUO5){super(WLQZepnUO5);}

	private ArrayList compareFields = new ArrayList();

	public mySecurityException clone() throws CloneNotSupportedException{
		mySecurityException cloned = (mySecurityException) super.clone();//浅克隆，克隆基本类型的字段
		...
		try {
    		for(Field field: fieldArr){//该类所有的public字段
				...
				Log.v("clone mySecurityException Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
	...
	@Override public boolean equals(Object other){
        ...
        mySecurityException otherObj = (mySecurityException) other;
        ...
        try{
            for(Field field:getClass().getFields()){
                ...
                Log.v("compare mySecurityException Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
                Log.v("compare mySecurityException Field",fieldThisValue+"---"+fieldOtherValue);
