...
public class myError extends Error implements Cloneable {
	public myError(){super();}
	public myError(java.lang.String Vn0yIi7fYR){super(Vn0yIi7fYR);}
	public myError(java.lang.String EpgHhniMRc, java.lang.Throwable VJBCx4EClH){super(EpgHhniMRc, VJBCx4EClH);}
	public myError(java.lang.Throwable CCIpjj2k7q){super(CCIpjj2k7q);}
	protected myError(java.lang.String VdNKq2bkFL, java.lang.Throwable NnvjScVFT1, boolean QNZgmDHwP7, boolean E0LNPWdDS1){super(VdNKq2bkFL, NnvjScVFT1, QNZgmDHwP7, E0LNPWdDS1);}

	private ArrayList compareFields = new ArrayList();

	public myError clone() throws CloneNotSupportedException{
		myError cloned = (myError) super.clone();//浅克隆，克隆基本类型的字段
		...
		try {
    		for(Field field: fieldArr){//该类所有的public字段
				...
				Log.v("clone myError Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
	...
	@Override public boolean equals(Object other){
        ...
        myError otherObj = (myError) other;
        ...
        try{
            for(Field field:getClass().getFields()){
                ...
                Log.v("compare myError Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
                Log.v("compare myError Field",fieldThisValue+"---"+fieldOtherValue);
