...
public class myNetworkOnMainThreadException extends NetworkOnMainThreadException implements Cloneable {
	public myNetworkOnMainThreadException(){super();}

	private ArrayList compareFields = new ArrayList();

	public myNetworkOnMainThreadException clone() throws CloneNotSupportedException{
		myNetworkOnMainThreadException cloned = (myNetworkOnMainThreadException) super.clone();//浅克隆，克隆基本类型的字段
		...
		try {
    		for(Field field: fieldArr){//该类所有的public字段
				...
				Log.v("clone myNetworkOnMainThreadException Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
	...
	@Override public boolean equals(Object other){
        ...
        myNetworkOnMainThreadException otherObj = (myNetworkOnMainThreadException) other;
        ...
        try{
            for(Field field:getClass().getFields()){
                ...
                Log.v("compare myNetworkOnMainThreadException Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
                Log.v("compare myNetworkOnMainThreadException Field",fieldThisValue+"---"+fieldOtherValue);
