...
public class myClipDescription extends ClipDescription implements Cloneable {
	public myClipDescription(java.lang.CharSequence TFLN2nFzYl, java.lang.String[] SzKsuq06h5){super(TFLN2nFzYl, SzKsuq06h5);}
	public myClipDescription(android.content.ClipDescription Ww5kISvpcq){super(Ww5kISvpcq);}

	private ArrayList compareFields = new ArrayList();

	public myClipDescription clone() throws CloneNotSupportedException{
		myClipDescription cloned = (myClipDescription) super.clone();//浅克隆，克隆基本类型的字段
		...
		try {
    		for(Field field: fieldArr){//该类所有的public字段
				...
				Log.v("clone myClipDescription Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
	...
	@Override public boolean equals(Object other){
        ...
        myClipDescription otherObj = (myClipDescription) other;
        ...
        try{
            for(Field field:getClass().getFields()){
                ...
                Log.v("compare myClipDescription Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
                Log.v("compare myClipDescription Field",fieldThisValue+"---"+fieldOtherValue);
