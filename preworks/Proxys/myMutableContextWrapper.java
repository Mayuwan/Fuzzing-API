...
public class myMutableContextWrapper extends MutableContextWrapper implements Cloneable {
	public myMutableContextWrapper(android.content.Context A6ufxWUPpB){super(A6ufxWUPpB);}

	private ArrayList compareFields = new ArrayList();

	public myMutableContextWrapper clone() throws CloneNotSupportedException{
		myMutableContextWrapper cloned = (myMutableContextWrapper) super.clone();//浅克隆，克隆基本类型的字段
		...
		try {
    		for(Field field: fieldArr){//该类所有的public字段
				...
				Log.v("clone myMutableContextWrapper Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
	...
	@Override public boolean equals(Object other){
        ...
        myMutableContextWrapper otherObj = (myMutableContextWrapper) other;
        ...
        try{
            for(Field field:getClass().getFields()){
                ...
                Log.v("compare myMutableContextWrapper Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
                Log.v("compare myMutableContextWrapper Field",fieldThisValue+"---"+fieldOtherValue);
