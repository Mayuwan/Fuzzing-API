...
public class myWrongMethodTypeException extends WrongMethodTypeException implements Cloneable {
	public myWrongMethodTypeException(){super();}
	public myWrongMethodTypeException(java.lang.String AOeM3z3Tzv){super(AOeM3z3Tzv);}

	private ArrayList compareFields = new ArrayList();

	public myWrongMethodTypeException clone() throws CloneNotSupportedException{
		myWrongMethodTypeException cloned = (myWrongMethodTypeException) super.clone();//浅克隆，克隆基本类型的字段
		...
		try {
    		for(Field field: fieldArr){//该类所有的public字段
				...
				Log.v("clone myWrongMethodTypeException Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
	...
	@Override public boolean equals(Object other){
        ...
        myWrongMethodTypeException otherObj = (myWrongMethodTypeException) other;
        ...
        try{
            for(Field field:getClass().getFields()){
                ...
                Log.v("compare myWrongMethodTypeException Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
                Log.v("compare myWrongMethodTypeException Field",fieldThisValue+"---"+fieldOtherValue);
