...
public class myContentUris extends ContentUris implements Cloneable {
	public myContentUris(){super();}

	private ArrayList compareFields = new ArrayList();

	public myContentUris clone() throws CloneNotSupportedException{
		myContentUris cloned = (myContentUris) super.clone();//浅克隆，克隆基本类型的字段
		...
		try {
    		for(Field field: fieldArr){//该类所有的public字段
				...
				Log.v("clone myContentUris Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
	...
	@Override public boolean equals(Object other){
        ...
        myContentUris otherObj = (myContentUris) other;
        ...
        try{
            for(Field field:getClass().getFields()){
                ...
                Log.v("compare myContentUris Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
                Log.v("compare myContentUris Field",fieldThisValue+"---"+fieldOtherValue);
