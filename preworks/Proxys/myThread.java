...
public class myThread extends Thread implements Cloneable {
	...
	public myThread(java.lang.Runnable M6PEOw4lDE){super(M6PEOw4lDE);}
	public myThread(java.lang.ThreadGroup H0eXiFJYN8, java.lang.Runnable S8rqCoyqnH){super(H0eXiFJYN8, S8rqCoyqnH);}
	public myThread(java.lang.String GcKogqpplY){super(GcKogqpplY);}
	public myThread(java.lang.ThreadGroup Nx5PcLtrXm, java.lang.String U0GcSKtRN3){super(Nx5PcLtrXm, U0GcSKtRN3);}
	public myThread(java.lang.Runnable IAvE3DXzJh, java.lang.String IxPjorcA9p){super(IAvE3DXzJh, IxPjorcA9p);}
	public myThread(java.lang.ThreadGroup P1ptjfefkn, java.lang.Runnable NrhJCY7vP6, java.lang.String Z4df3JmfjK){super(P1ptjfefkn, NrhJCY7vP6, Z4df3JmfjK);}
	public myThread(java.lang.ThreadGroup NolMGvrHUG, java.lang.Runnable AoyXhFuzqU, java.lang.String TANdJcef2I, long Ad63hc3L2V){super(NolMGvrHUG, AoyXhFuzqU, TANdJcef2I, Ad63hc3L2V);}

	private ArrayList compareFields = new ArrayList();

	public myThread clone() throws CloneNotSupportedException{
		myThread cloned = (myThread) super.clone();//浅克隆，克隆基本类型的字段
		...
		try {
    		for(Field field: fieldArr){//该类所有的public字段
				...
				Log.v("clone myThread Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
	...
	@Override public boolean equals(Object other){
        ...
        myThread otherObj = (myThread) other;
        ...
        try{
            for(Field field:getClass().getFields()){
                ...
                Log.v("compare myThread Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
                Log.v("compare myThread Field",fieldThisValue+"---"+fieldOtherValue);
