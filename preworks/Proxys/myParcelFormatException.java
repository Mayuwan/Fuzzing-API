...
public class myParcelFormatException extends ParcelFormatException implements Cloneable {
	public myParcelFormatException(){super();}
	public myParcelFormatException(java.lang.String GrVlY7dfer){super(GrVlY7dfer);}

	private ArrayList compareFields = new ArrayList();

	public myParcelFormatException clone() throws CloneNotSupportedException{
		myParcelFormatException cloned = (myParcelFormatException) super.clone();//浅克隆，克隆基本类型的字段
		...
		try {
    		for(Field field: fieldArr){//该类所有的public字段
				...
				Log.v("clone myParcelFormatException Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
	...
	@Override public boolean equals(Object other){
        ...
        myParcelFormatException otherObj = (myParcelFormatException) other;
        ...
        try{
            for(Field field:getClass().getFields()){
                ...
                Log.v("compare myParcelFormatException Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
                Log.v("compare myParcelFormatException Field",fieldThisValue+"---"+fieldOtherValue);
