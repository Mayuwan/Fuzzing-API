...
public class myAbstractMethodError extends AbstractMethodError implements Cloneable {
	public myAbstractMethodError(){super();}
	public myAbstractMethodError(java.lang.String EdpDmYEkXR){super(EdpDmYEkXR);}

	private ArrayList compareFields = new ArrayList();

	public myAbstractMethodError clone() throws CloneNotSupportedException{
		myAbstractMethodError cloned = (myAbstractMethodError) super.clone();//浅克隆，克隆基本类型的字段
		...
		try {
    		for(Field field: fieldArr){//该类所有的public字段
				...
				Log.v("clone myAbstractMethodError Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
	...
	@Override public boolean equals(Object other){
        ...
        myAbstractMethodError otherObj = (myAbstractMethodError) other;
        ...
        try{
            for(Field field:getClass().getFields()){
                ...
                Log.v("compare myAbstractMethodError Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
                Log.v("compare myAbstractMethodError Field",fieldThisValue+"---"+fieldOtherValue);
