...
public class myActivity extends Activity implements Cloneable {
	public myActivity(){super();}

	private ArrayList compareFields = new ArrayList();

	public myActivity clone() throws CloneNotSupportedException{
		myActivity cloned = (myActivity) super.clone();//浅克隆，克隆基本类型的字段
		...
		try {
    		for(Field field: fieldArr){//该类所有的public字段
				...
				Log.v("clone myActivity Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
	...
	@Override public boolean equals(Object other){
        ...
        myActivity otherObj = (myActivity) other;
        ...
        try{
            for(Field field:getClass().getFields()){
                ...
                Log.v("compare myActivity Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
                Log.v("compare myActivity Field",fieldThisValue+"---"+fieldOtherValue);
