...
public class mySyncResult extends SyncResult implements Cloneable {
	public mySyncResult(){super();}

	private ArrayList compareFields = new ArrayList();

	public mySyncResult clone() throws CloneNotSupportedException{
		mySyncResult cloned = (mySyncResult) super.clone();//浅克隆，克隆基本类型的字段
		...
		try {
    		for(Field field: fieldArr){//该类所有的public字段
				...
				Log.v("clone mySyncResult Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
	...
	@Override public boolean equals(Object other){
        ...
        mySyncResult otherObj = (mySyncResult) other;
        ...
        try{
            for(Field field:getClass().getFields()){
                ...
                Log.v("compare mySyncResult Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
                Log.v("compare mySyncResult Field",fieldThisValue+"---"+fieldOtherValue);
