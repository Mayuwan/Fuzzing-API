...
public class myEnumConstantNotPresentException extends EnumConstantNotPresentException implements Cloneable {
	public myEnumConstantNotPresentException(java.lang.Class AdPIh7gtTr, java.lang.String YzTVw12zzm){super(AdPIh7gtTr, YzTVw12zzm);}

	private ArrayList compareFields = new ArrayList();

	public myEnumConstantNotPresentException clone() throws CloneNotSupportedException{
		myEnumConstantNotPresentException cloned = (myEnumConstantNotPresentException) super.clone();//浅克隆，克隆基本类型的字段
		...
		try {
    		for(Field field: fieldArr){//该类所有的public字段
				...
				Log.v("clone myEnumConstantNotPresentException Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
	...
	@Override public boolean equals(Object other){
        ...
        myEnumConstantNotPresentException otherObj = (myEnumConstantNotPresentException) other;
        ...
        try{
            for(Field field:getClass().getFields()){
                ...
                Log.v("compare myEnumConstantNotPresentException Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
                Log.v("compare myEnumConstantNotPresentException Field",fieldThisValue+"---"+fieldOtherValue);
