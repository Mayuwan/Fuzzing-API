...
public class myIndexOutOfBoundsException extends IndexOutOfBoundsException implements Cloneable {
	public myIndexOutOfBoundsException(){super();}
	public myIndexOutOfBoundsException(java.lang.String LYTJe2Q0Vp){super(LYTJe2Q0Vp);}

	private ArrayList compareFields = new ArrayList();

	public myIndexOutOfBoundsException clone() throws CloneNotSupportedException{
		myIndexOutOfBoundsException cloned = (myIndexOutOfBoundsException) super.clone();//浅克隆，克隆基本类型的字段
		...
		try {
    		for(Field field: fieldArr){//该类所有的public字段
				...
				Log.v("clone myIndexOutOfBoundsException Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
	...
	@Override public boolean equals(Object other){
        ...
        myIndexOutOfBoundsException otherObj = (myIndexOutOfBoundsException) other;
        ...
        try{
            for(Field field:getClass().getFields()){
                ...
                Log.v("compare myIndexOutOfBoundsException Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
                Log.v("compare myIndexOutOfBoundsException Field",fieldThisValue+"---"+fieldOtherValue);
