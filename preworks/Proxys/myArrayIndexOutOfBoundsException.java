...
public class myArrayIndexOutOfBoundsException extends ArrayIndexOutOfBoundsException implements Cloneable {
	public myArrayIndexOutOfBoundsException(){super();}
	public myArrayIndexOutOfBoundsException(int VAxj1jnM8G){super(VAxj1jnM8G);}
	public myArrayIndexOutOfBoundsException(java.lang.String LVB1IoCgix){super(LVB1IoCgix);}

	private ArrayList compareFields = new ArrayList();

	public myArrayIndexOutOfBoundsException clone() throws CloneNotSupportedException{
		myArrayIndexOutOfBoundsException cloned = (myArrayIndexOutOfBoundsException) super.clone();//浅克隆，克隆基本类型的字段
		...
		try {
    		for(Field field: fieldArr){//该类所有的public字段
				...
				Log.v("clone myArrayIndexOutOfBoundsException Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
	...
	@Override public boolean equals(Object other){
        ...
        myArrayIndexOutOfBoundsException otherObj = (myArrayIndexOutOfBoundsException) other;
        ...
        try{
            for(Field field:getClass().getFields()){
                ...
                Log.v("compare myArrayIndexOutOfBoundsException Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
                Log.v("compare myArrayIndexOutOfBoundsException Field",fieldThisValue+"---"+fieldOtherValue);
