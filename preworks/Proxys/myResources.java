...
public class myResources extends Resources implements Cloneable {
	public myResources(android.content.res.AssetManager KjV1tpjI08, android.util.DisplayMetrics M5UhkWDIIB, android.content.res.Configuration MGsUjxuu1m){super(KjV1tpjI08, M5UhkWDIIB, MGsUjxuu1m);}

	private ArrayList compareFields = new ArrayList();

	public myResources clone() throws CloneNotSupportedException{
		myResources cloned = (myResources) super.clone();//浅克隆，克隆基本类型的字段
		...
		try {
    		for(Field field: fieldArr){//该类所有的public字段
				...
				Log.v("clone myResources Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
	...
	@Override public boolean equals(Object other){
        ...
        myResources otherObj = (myResources) other;
        ...
        try{
            for(Field field:getClass().getFields()){
                ...
                Log.v("compare myResources Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
                Log.v("compare myResources Field",fieldThisValue+"---"+fieldOtherValue);
