...
public class myOperationApplicationException extends OperationApplicationException implements Cloneable {
	public myOperationApplicationException(){super();}
	public myOperationApplicationException(java.lang.String F5G8FMztGm){super(F5G8FMztGm);}
	public myOperationApplicationException(java.lang.String He7CpakWmL, java.lang.Throwable MnvtplDEVx){super(He7CpakWmL, MnvtplDEVx);}
	public myOperationApplicationException(java.lang.Throwable ScsJeCGGPk){super(ScsJeCGGPk);}
	public myOperationApplicationException(int HR9KaqLsci){super(HR9KaqLsci);}
	public myOperationApplicationException(java.lang.String AMq4oC4DOM, int Cj9Idv5aiU){super(AMq4oC4DOM, Cj9Idv5aiU);}

	private ArrayList compareFields = new ArrayList();

	public myOperationApplicationException clone() throws CloneNotSupportedException{
		myOperationApplicationException cloned = (myOperationApplicationException) super.clone();//浅克隆，克隆基本类型的字段
		...
		try {
    		for(Field field: fieldArr){//该类所有的public字段
				...
				Log.v("clone myOperationApplicationException Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
	...
	@Override public boolean equals(Object other){
        ...
        myOperationApplicationException otherObj = (myOperationApplicationException) other;
        ...
        try{
            for(Field field:getClass().getFields()){
                ...
                Log.v("compare myOperationApplicationException Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
                Log.v("compare myOperationApplicationException Field",fieldThisValue+"---"+fieldOtherValue);
