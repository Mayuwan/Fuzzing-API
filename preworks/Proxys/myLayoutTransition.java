...
public class myLayoutTransition extends LayoutTransition implements Cloneable {
	public myLayoutTransition(){super();}

	private ArrayList compareFields = new ArrayList();

	public myLayoutTransition clone() throws CloneNotSupportedException{
		myLayoutTransition cloned = (myLayoutTransition) super.clone();//浅克隆，克隆基本类型的字段
		...
		try {
    		for(Field field: fieldArr){//该类所有的public字段
				...
				Log.v("clone myLayoutTransition Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
	...
	@Override public boolean equals(Object other){
        ...
        myLayoutTransition otherObj = (myLayoutTransition) other;
        ...
        try{
            for(Field field:getClass().getFields()){
                ...
                Log.v("compare myLayoutTransition Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
                Log.v("compare myLayoutTransition Field",fieldThisValue+"---"+fieldOtherValue);
