...
public class myAnnotationFormatError extends AnnotationFormatError implements Cloneable {
	public myAnnotationFormatError(java.lang.String Ek6030NyPK){super(Ek6030NyPK);}
	public myAnnotationFormatError(java.lang.String QgjVgYuDW3, java.lang.Throwable VUGhtc472o){super(QgjVgYuDW3, VUGhtc472o);}
	public myAnnotationFormatError(java.lang.Throwable S371otcRmO){super(S371otcRmO);}

	private ArrayList compareFields = new ArrayList();

	public myAnnotationFormatError clone() throws CloneNotSupportedException{
		myAnnotationFormatError cloned = (myAnnotationFormatError) super.clone();//浅克隆，克隆基本类型的字段
		...
		try {
    		for(Field field: fieldArr){//该类所有的public字段
				...
				Log.v("clone myAnnotationFormatError Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
	...
	@Override public boolean equals(Object other){
        ...
        myAnnotationFormatError otherObj = (myAnnotationFormatError) other;
        ...
        try{
            for(Field field:getClass().getFields()){
                ...
                Log.v("compare myAnnotationFormatError Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
                Log.v("compare myAnnotationFormatError Field",fieldThisValue+"---"+fieldOtherValue);
