...
public class myAssertionError extends AssertionError implements Cloneable {
	public myAssertionError(){super();}
	public myAssertionError(java.lang.Object DrCkFCI3DO){super(DrCkFCI3DO);}
	public myAssertionError(boolean KDR4ieU2Gw){super(KDR4ieU2Gw);}
	public myAssertionError(char F6uArGimpo){super(F6uArGimpo);}
	public myAssertionError(int UQHLXkb5lz){super(UQHLXkb5lz);}
	public myAssertionError(long FiGCrDvlqQ){super(FiGCrDvlqQ);}
	public myAssertionError(float LhzJ6aC37J){super(LhzJ6aC37J);}
	public myAssertionError(double AS56L8CxIg){super(AS56L8CxIg);}
	public myAssertionError(java.lang.String QRfOg7bOKX, java.lang.Throwable MkpfkgE2St){super(QRfOg7bOKX, MkpfkgE2St);}

	private ArrayList compareFields = new ArrayList();

	public myAssertionError clone() throws CloneNotSupportedException{
		myAssertionError cloned = (myAssertionError) super.clone();//浅克隆，克隆基本类型的字段
		...
		try {
    		for(Field field: fieldArr){//该类所有的public字段
				...
				Log.v("clone myAssertionError Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
	...
	@Override public boolean equals(Object other){
        ...
        myAssertionError otherObj = (myAssertionError) other;
        ...
        try{
            for(Field field:getClass().getFields()){
                ...
                Log.v("compare myAssertionError Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
                Log.v("compare myAssertionError Field",fieldThisValue+"---"+fieldOtherValue);
