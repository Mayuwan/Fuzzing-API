...
public class myProxy extends Proxy implements Cloneable {
	protected myProxy(java.lang.reflect.InvocationHandler HGYCBkSFmV){super(HGYCBkSFmV);}

	private ArrayList compareFields = new ArrayList();

	public myProxy clone() throws CloneNotSupportedException{
		myProxy cloned = (myProxy) super.clone();//浅克隆，克隆基本类型的字段
		...
		try {
    		for(Field field: fieldArr){//该类所有的public字段
				...
				Log.v("clone myProxy Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
	...
	@Override public boolean equals(Object other){
        ...
        myProxy otherObj = (myProxy) other;
        ...
        try{
            for(Field field:getClass().getFields()){
                ...
                Log.v("compare myProxy Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
                Log.v("compare myProxy Field",fieldThisValue+"---"+fieldOtherValue);
