...
public class myComponentInfo extends ComponentInfo implements Cloneable {
	public myComponentInfo(){super();}
	public myComponentInfo(android.content.pm.ComponentInfo S5yRbOtJf1){super(S5yRbOtJf1);}
	protected myComponentInfo(android.os.Parcel Sw4J2T3urs){super(Sw4J2T3urs);}

	private ArrayList compareFields = new ArrayList();

	public myComponentInfo clone() throws CloneNotSupportedException{
		myComponentInfo cloned = (myComponentInfo) super.clone();//浅克隆，克隆基本类型的字段
		...
		try {
    		for(Field field: fieldArr){//该类所有的public字段
				...
				Log.v("clone myComponentInfo Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
	...
	@Override public boolean equals(Object other){
        ...
        myComponentInfo otherObj = (myComponentInfo) other;
        ...
        try{
            for(Field field:getClass().getFields()){
                ...
                Log.v("compare myComponentInfo Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
                Log.v("compare myComponentInfo Field",fieldThisValue+"---"+fieldOtherValue);
