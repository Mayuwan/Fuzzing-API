...
public class myRemoteCallbackList extends RemoteCallbackList implements Cloneable {
	public myRemoteCallbackList(){super();}

	private ArrayList compareFields = new ArrayList();

	public myRemoteCallbackList clone() throws CloneNotSupportedException{
		myRemoteCallbackList cloned = (myRemoteCallbackList) super.clone();//浅克隆，克隆基本类型的字段
		...
		try {
    		for(Field field: fieldArr){//该类所有的public字段
				...
				Log.v("clone myRemoteCallbackList Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
	...
	@Override public boolean equals(Object other){
        ...
        myRemoteCallbackList otherObj = (myRemoteCallbackList) other;
        ...
        try{
            for(Field field:getClass().getFields()){
                ...
                Log.v("compare myRemoteCallbackList Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
                Log.v("compare myRemoteCallbackList Field",fieldThisValue+"---"+fieldOtherValue);
