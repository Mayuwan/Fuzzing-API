...
public class myInterruptedException extends InterruptedException implements Cloneable {
	public myInterruptedException(){super();}
	public myInterruptedException(java.lang.String XDPdscNRc8){super(XDPdscNRc8);}

	private ArrayList compareFields = new ArrayList();

	public myInterruptedException clone() throws CloneNotSupportedException{
		myInterruptedException cloned = (myInterruptedException) super.clone();//浅克隆，克隆基本类型的字段
		...
		try {
    		for(Field field: fieldArr){//该类所有的public字段
				...
				Log.v("clone myInterruptedException Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
	...
	@Override public boolean equals(Object other){
        ...
        myInterruptedException otherObj = (myInterruptedException) other;
        ...
        try{
            for(Field field:getClass().getFields()){
                ...
                Log.v("compare myInterruptedException Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
                Log.v("compare myInterruptedException Field",fieldThisValue+"---"+fieldOtherValue);
