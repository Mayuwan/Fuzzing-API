...
public class myIncompatibleClassChangeError extends IncompatibleClassChangeError implements Cloneable {
	public myIncompatibleClassChangeError(){super();}
	public myIncompatibleClassChangeError(java.lang.String PHcovWNzve){super(PHcovWNzve);}

	private ArrayList compareFields = new ArrayList();

	public myIncompatibleClassChangeError clone() throws CloneNotSupportedException{
		myIncompatibleClassChangeError cloned = (myIncompatibleClassChangeError) super.clone();//浅克隆，克隆基本类型的字段
		...
		try {
    		for(Field field: fieldArr){//该类所有的public字段
				...
				Log.v("clone myIncompatibleClassChangeError Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
	...
	@Override public boolean equals(Object other){
        ...
        myIncompatibleClassChangeError otherObj = (myIncompatibleClassChangeError) other;
        ...
        try{
            for(Field field:getClass().getFields()){
                ...
                Log.v("compare myIncompatibleClassChangeError Field",Modifier.toString(field.getModifiers())+" "+field.getType().getName()+" "+field.getName());
                Log.v("compare myIncompatibleClassChangeError Field",fieldThisValue+"---"+fieldOtherValue);
